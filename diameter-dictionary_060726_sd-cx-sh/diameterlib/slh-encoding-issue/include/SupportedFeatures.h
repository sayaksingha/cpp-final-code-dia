#ifndef SLH_SUPPORTEDFEATURES_H
#define SLH_SUPPORTEDFEATURES_H
...
class SupportedFeatures : public DiameterBaseInterface
{
	...
	public:
		...
		mVendorId = new Integer32(*(objSupportedFeatures.mVendorId));
		...
		/*!		Function to set the recent Integer32 type of argument VendorId for datatype SupportedFeatures
		*/
		...
		*/
		...
		/*!		Function to get Integer32 type of argument VendorId for datatype SupportedFeatures
