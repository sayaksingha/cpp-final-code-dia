...
typedef enum _tags_LCSRoutingInfoAnswer
{
	...
	LCSRoutingInfoAnswer_ROUTERECORD	= 17,
...
class LCSRoutingInfoAnswer : public DiameterBase 
{
	private:
		...
		list<Address*>* 		mPPRAddressList;

		list<Address*>::iterator 		mPPRAddressIterator;
	...
	public:
		...
		*/
		...
		list<Address*>* getPPRAddressList();

		list<Address*>* setPPRAddressList();
