...
#include "cx/include/OCReportType.h"
using namespace std;
...
class OCOLR : public DiameterBaseInterface
{
	...
	public:
		...
		if(objOCOLR.mOCRegTimerExt != NULL)
		mOCRegTimerExt = new Unsigned32(*(objOCOLR.mOCRegTimerExt));
		...
		*/
		...
		//!Function to set values
		/*!		Function to set the recent Unsigned32 type of argument OCRegTimerExt for datatype OCOLR
		*/
		Unsigned32* setOCRegTimerExt();

		//! Function to reset 
		/*!		Function to reset NULL type of argument OCRegTimerExt for datatype OCOLR
		*/
		void resetOCRegTimerExt();

		//!Function to get values
		/*!		Function to get Unsigned32 type of argument OCRegTimerExt for datatype OCOLR
		Throws exception of which type and Summary of Exception
		*/
		Unsigned32* getOCRegTimerExt();
