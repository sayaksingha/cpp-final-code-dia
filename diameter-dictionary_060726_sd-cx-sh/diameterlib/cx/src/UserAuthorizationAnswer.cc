...
using namespace CX;
BOOLEAN UserAuthorizationAnswer::isPresent(int tag){
...
UserAuthorizationAnswer::UserAuthorizationAnswer()
{
	...
	mTagsPresent.reset();
	mMandatoryAvpCheckVal= bitset<18>(string("111011001111111101"));
...
OctetString* UserAuthorizationAnswer::setSessionId(){
	mMandatoryAvpSetVal [UserAuthorizationAnswer_SESSIONID] = 1;
	if(mSessionId == NULL)
	{
		mSessionId = new OctetString();
		mTagsPresent[UserAuthorizationAnswer_SESSIONID] = 1;
		return mSessionId;
	}
	return mSessionId;
}

void UserAuthorizationAnswer::resetSessionId(){
	mTagsPresent[UserAuthorizationAnswer_SESSIONID] = 0;
	if(mSessionId != NULL)
	{
		delete mSessionId; 
		mSessionId = NULL;
...
DRMP* UserAuthorizationAnswer::setDRMP(){
	if(mDRMP == NULL)
	{
		mDRMP = new DRMP();
		mTagsPresent[UserAuthorizationAnswer_DRMP] = 1;
		return mDRMP;
	}
	return mDRMP;
}

void UserAuthorizationAnswer::resetDRMP(){
	mTagsPresent[UserAuthorizationAnswer_DRMP] = 0;
	if(mDRMP != NULL)
	{
		delete mDRMP; 
		mDRMP = NULL;
...
Unsigned32* UserAuthorizationAnswer::setResultCode(){
	mMandatoryAvpSetVal [UserAuthorizationAnswer_RESULTCODE] = 1;
	if(mResultCode == NULL)
	{
		mResultCode = new Unsigned32();
		mTagsPresent[UserAuthorizationAnswer_RESULTCODE] = 1;
		return mResultCode;
	}
	return mResultCode;
}

void UserAuthorizationAnswer::resetResultCode(){
	mTagsPresent[UserAuthorizationAnswer_RESULTCODE] = 0;
	if(mResultCode != NULL)
	{
		delete mResultCode; 
		mResultCode = NULL;
...
AuthSessionState* UserAuthorizationAnswer::setAuthSessionState(){
	mMandatoryAvpSetVal [UserAuthorizationAnswer_AUTHSESSIONSTATE] = 1;
	if(mAuthSessionState == NULL)
	{
		mAuthSessionState = new AuthSessionState();
		mTagsPresent[UserAuthorizationAnswer_AUTHSESSIONSTATE] = 1;
		return mAuthSessionState;
	}
	return mAuthSessionState;
}

void UserAuthorizationAnswer::resetAuthSessionState(){
	mTagsPresent[UserAuthorizationAnswer_AUTHSESSIONSTATE] = 0;
	if(mAuthSessionState != NULL)
	{
		delete mAuthSessionState; 
		mAuthSessionState = NULL;
...
OctetString* UserAuthorizationAnswer::setOriginHost(){
	mMandatoryAvpSetVal [UserAuthorizationAnswer_ORIGINHOST] = 1;
	if(mOriginHost == NULL)
	{
		mOriginHost = new OctetString();
		mTagsPresent[UserAuthorizationAnswer_ORIGINHOST] = 1;
		return mOriginHost;
	}
	return mOriginHost;
}

void UserAuthorizationAnswer::resetOriginHost(){
	mTagsPresent[UserAuthorizationAnswer_ORIGINHOST] = 0;
	if(mOriginHost != NULL)
	{
		delete mOriginHost; 
		mOriginHost = NULL;
...
OctetString* UserAuthorizationAnswer::setOriginRealm(){
	mMandatoryAvpSetVal [UserAuthorizationAnswer_ORIGINREALM] = 1;
	if(mOriginRealm == NULL)
	{
		mOriginRealm = new OctetString();
		mTagsPresent[UserAuthorizationAnswer_ORIGINREALM] = 1;
		return mOriginRealm;
	}
	return mOriginRealm;
}

void UserAuthorizationAnswer::resetOriginRealm(){
	mTagsPresent[UserAuthorizationAnswer_ORIGINREALM] = 0;
	if(mOriginRealm != NULL)
	{
		delete mOriginRealm; 
		mOriginRealm = NULL;
...
OctetString* UserAuthorizationAnswer::setServerName(){
	mMandatoryAvpSetVal [UserAuthorizationAnswer_SERVERNAME] = 1;
	if(mServerName == NULL)
	{
		mServerName = new OctetString();
		mTagsPresent[UserAuthorizationAnswer_SERVERNAME] = 1;
		return mServerName;
	}
	return mServerName;
}

void UserAuthorizationAnswer::resetServerName(){
	mTagsPresent[UserAuthorizationAnswer_SERVERNAME] = 0;
	if(mServerName != NULL)
	{
		delete mServerName; 
		mServerName = NULL;
...
OctetString* UserAuthorizationAnswer::setErrorMessage(){
	if(mErrorMessage == NULL)
	{
		mErrorMessage = new OctetString();
		mTagsPresent[UserAuthorizationAnswer_ERRORMESSAGE] = 1;
		return mErrorMessage;
	}
	return mErrorMessage;
}

void UserAuthorizationAnswer::resetErrorMessage(){
	mTagsPresent[UserAuthorizationAnswer_ERRORMESSAGE] = 0;
	if(mErrorMessage != NULL)
	{
		delete mErrorMessage; 
		mErrorMessage = NULL;
...
OctetString* UserAuthorizationAnswer::getSessionId(){
	if(NULL == mSessionId) {
...
DRMP* UserAuthorizationAnswer::getDRMP(){
	if(NULL == mDRMP) {
...
CX::VendorSpecificApplicationId* UserAuthorizationAnswer::getVendorSpecificApplicationId()
{
	if(mVendorSpecificApplicationIdGrp == NULL)
	{
...
CX::VendorSpecificApplicationId* UserAuthorizationAnswer::setVendorSpecificApplicationId(){
	if(mVendorSpecificApplicationIdGrp == NULL)
		mVendorSpecificApplicationIdGrp = new VendorSpecificApplicationId();
	mTagsPresent[UserAuthorizationAnswer_VENDORSPECIFICAPPLICATIONID] = 1;
	mMandatoryAvpSetVal[UserAuthorizationAnswer_VENDORSPECIFICAPPLICATIONID] = 1;
	return mVendorSpecificApplicationIdGrp;
}

void UserAuthorizationAnswer::resetVendorSpecificApplicationId(){
	mTagsPresent[UserAuthorizationAnswer_VENDORSPECIFICAPPLICATIONID] = 0;
	if(mVendorSpecificApplicationIdGrp != NULL)
		delete mVendorSpecificApplicationIdGrp;
}

Unsigned32* UserAuthorizationAnswer::getResultCode(){
	if(NULL == mResultCode) {
...
ExperimentalResult* UserAuthorizationAnswer::getExperimentalResult()
{
	if(mExperimentalResultGrp == NULL)
	{
...
ExperimentalResult* UserAuthorizationAnswer::setExperimentalResult(){
	if(mExperimentalResultGrp == NULL)
		mExperimentalResultGrp = new ExperimentalResult();
	mTagsPresent[UserAuthorizationAnswer_EXPERIMENTALRESULT] = 1;
	mMandatoryAvpSetVal[UserAuthorizationAnswer_EXPERIMENTALRESULT] = 1;
	return mExperimentalResultGrp;
}

void UserAuthorizationAnswer::resetExperimentalResult(){
	mTagsPresent[UserAuthorizationAnswer_EXPERIMENTALRESULT] = 0;
	if(mExperimentalResultGrp != NULL)
		delete mExperimentalResultGrp;
}

AuthSessionState* UserAuthorizationAnswer::getAuthSessionState(){
...
OctetString* UserAuthorizationAnswer::getOriginHost(){
	if(NULL == mOriginHost) {
...
OctetString* UserAuthorizationAnswer::getOriginRealm(){
...
OCSupportedFeatures* UserAuthorizationAnswer::getOCSupportedFeatures()
{
	if(mOCSupportedFeaturesGrp == NULL)
	{
...
OCSupportedFeatures* UserAuthorizationAnswer::setOCSupportedFeatures(){
	if(mOCSupportedFeaturesGrp == NULL)
		mOCSupportedFeaturesGrp = new OCSupportedFeatures();
	mTagsPresent[UserAuthorizationAnswer_OCSUPPORTEDFEATURES] = 1;
	mMandatoryAvpSetVal[UserAuthorizationAnswer_OCSUPPORTEDFEATURES] = 1;
	return mOCSupportedFeaturesGrp;
}

void UserAuthorizationAnswer::resetOCSupportedFeatures(){
	mTagsPresent[UserAuthorizationAnswer_OCSUPPORTEDFEATURES] = 0;
	if(mOCSupportedFeaturesGrp != NULL)
		delete mOCSupportedFeaturesGrp;
}

OCOLR* UserAuthorizationAnswer::getOCOLR()
{
	if(mOCOLRGrp == NULL)
	{
...
OCOLR* UserAuthorizationAnswer::setOCOLR(){
	if(mOCOLRGrp == NULL)
		mOCOLRGrp = new OCOLR();
	mTagsPresent[UserAuthorizationAnswer_OCOLR] = 1;
	mMandatoryAvpSetVal[UserAuthorizationAnswer_OCOLR] = 1;
	return mOCOLRGrp;
}

void UserAuthorizationAnswer::resetOCOLR(){
	mTagsPresent[UserAuthorizationAnswer_OCOLR] = 0;
	if(mOCOLRGrp != NULL)
		delete mOCOLRGrp;
}

list<Load*>* UserAuthorizationAnswer::getLoadGrpList()
{
	if(mLoadGrpList == NULL)
	{
	...
	for(auto itr : *mLoadGrpList)
	{
		...
		{
			mTagsPresent[UserAuthorizationAnswer_LOAD] = 0;
			mLoadGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "Load is Null");
			throw lTssDiaMsgException;
		}
...
list<Load*>* UserAuthorizationAnswer::setLoadGrpList(){
	mTagsPresent[UserAuthorizationAnswer_LOAD] = 1;
	if(mLoadGrpList == NULL)
...
void UserAuthorizationAnswer::resetLoadGrpList(){
	mTagsPresent[UserAuthorizationAnswer_LOAD] = 0;
	if(mLoadGrpList != NULL)
		delete mLoadGrpList;
}

list<SupportedFeatures*>* UserAuthorizationAnswer::getSupportedFeaturesGrpList()
{
	if(mSupportedFeaturesGrpList == NULL)
	{
	...
	for(auto itr : *mSupportedFeaturesGrpList)
	{
		...
		{
			mTagsPresent[UserAuthorizationAnswer_SUPPORTEDFEATURES] = 0;
			mSupportedFeaturesGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "SupportedFeatures is Null");
			throw lTssDiaMsgException;
		}
...
list<SupportedFeatures*>* UserAuthorizationAnswer::setSupportedFeaturesGrpList(){
	mTagsPresent[UserAuthorizationAnswer_SUPPORTEDFEATURES] = 1;
	if(mSupportedFeaturesGrpList == NULL)
...
void UserAuthorizationAnswer::resetSupportedFeaturesGrpList(){
	mTagsPresent[UserAuthorizationAnswer_SUPPORTEDFEATURES] = 0;
	if(mSupportedFeaturesGrpList != NULL)
		delete mSupportedFeaturesGrpList;
}

OctetString* UserAuthorizationAnswer::getServerName(){
	if(NULL == mServerName) {
...
ServerCapabilities* UserAuthorizationAnswer::getServerCapabilities()
{
	if(mServerCapabilitiesGrp == NULL)
	{
...
ServerCapabilities* UserAuthorizationAnswer::setServerCapabilities(){
	if(mServerCapabilitiesGrp == NULL)
		mServerCapabilitiesGrp = new ServerCapabilities();
	mTagsPresent[UserAuthorizationAnswer_SERVERCAPABILITIES] = 1;
	mMandatoryAvpSetVal[UserAuthorizationAnswer_SERVERCAPABILITIES] = 1;
	return mServerCapabilitiesGrp;
}

void UserAuthorizationAnswer::resetServerCapabilities(){
	mTagsPresent[UserAuthorizationAnswer_SERVERCAPABILITIES] = 0;
	if(mServerCapabilitiesGrp != NULL)
		delete mServerCapabilitiesGrp;
}

OctetString* UserAuthorizationAnswer::getErrorMessage(){
...
FailedAVP* UserAuthorizationAnswer::getFailedAVP()
{
	if(mFailedAVPGrp == NULL)
	{
...
FailedAVP* UserAuthorizationAnswer::setFailedAVP(){
	if(mFailedAVPGrp == NULL)
		mFailedAVPGrp = new FailedAVP();
	mTagsPresent[UserAuthorizationAnswer_FAILEDAVP] = 1;
	mMandatoryAvpSetVal[UserAuthorizationAnswer_FAILEDAVP] = 1;
	return mFailedAVPGrp;
}

void UserAuthorizationAnswer::resetFailedAVP(){
	mTagsPresent[UserAuthorizationAnswer_FAILEDAVP] = 0;
	if(mFailedAVPGrp != NULL)
		delete mFailedAVPGrp;
}

list<CX::ProxyInfo*>* UserAuthorizationAnswer::getProxyInfoGrpList()
{
	if(mProxyInfoGrpList == NULL)
	{
	...
	for(auto itr : *mProxyInfoGrpList)
	{
		...
		{
			mTagsPresent[UserAuthorizationAnswer_PROXYINFO] = 0;
			mProxyInfoGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "ProxyInfo is Null");
			throw lTssDiaMsgException;
		}
...
list<CX::ProxyInfo*>* UserAuthorizationAnswer::setProxyInfoGrpList(){
	mTagsPresent[UserAuthorizationAnswer_PROXYINFO] = 1;
	if(mProxyInfoGrpList == NULL)
		mProxyInfoGrpList = new list<CX::ProxyInfo*>;
	mMandatoryAvpSetVal[UserAuthorizationAnswer_PROXYINFO] = 1;
	mProxyInfoGrpList->clear();
	return mProxyInfoGrpList;
}

void UserAuthorizationAnswer::resetProxyInfoGrpList(){
	mTagsPresent[UserAuthorizationAnswer_PROXYINFO] = 0;
	if(mProxyInfoGrpList != NULL)
		delete mProxyInfoGrpList;
}

list<OctetString*>* UserAuthorizationAnswer::getRouteRecordList()
{
	if(mRouteRecordList == NULL)
	{
...
list<OctetString*>* UserAuthorizationAnswer::setRouteRecordList() {
	mTagsPresent[UserAuthorizationAnswer_ROUTERECORD] = 1;
	if(mRouteRecordList == NULL)
		mRouteRecordList = new list<OctetString*>;
	mMandatoryAvpSetVal [UserAuthorizationAnswer_ROUTERECORD] = 1;
	mRouteRecordList->clear();
	return mRouteRecordList;
}

void UserAuthorizationAnswer::resetRouteRecordList(){
	mTagsPresent[UserAuthorizationAnswer_ROUTERECORD] = 0;
	if(mRouteRecordList != NULL)
		delete mRouteRecordList;
}
...
int UserAuthorizationAnswer::Encode(byteArray *array)
{
	...
	for(unsigned int i = 0 ; i < mTagsPresent.size() ; ++i )
	{
		...
		switch(i)
		{
			case UserAuthorizationAnswer_SESSIONID:
			{
					array->size+=4;
				...
				break;
			case UserAuthorizationAnswer_DRMP:
			{
					array->size+=4;
				...
				break;
			case UserAuthorizationAnswer_VENDORSPECIFICAPPLICATIONID:
			{
				array->size+=4;
				...
				break;
			case UserAuthorizationAnswer_RESULTCODE:
			{
					array->size+=4;
				...
				break;
			case UserAuthorizationAnswer_EXPERIMENTALRESULT:
			{
				array->size+=4;
				...
				break;
			case UserAuthorizationAnswer_AUTHSESSIONSTATE:
			{
					array->size+=4;
				...
				break;
			case UserAuthorizationAnswer_ORIGINHOST:
			{
					array->size+=4;
				...
				break;
			case UserAuthorizationAnswer_ORIGINREALM:
			{
					array->size+=4;
				...
				break;
			case UserAuthorizationAnswer_OCSUPPORTEDFEATURES:
			{
				array->size+=4;
				...
				break;
			case UserAuthorizationAnswer_OCOLR:
			{
				array->size+=4;
				...
				break;
			case UserAuthorizationAnswer_LOAD:
			{
				if( mLoadGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case UserAuthorizationAnswer_SUPPORTEDFEATURES:
			{
				if( mSupportedFeaturesGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case UserAuthorizationAnswer_SERVERNAME:
			{
					array->size+=4;
				...
				break;
			case UserAuthorizationAnswer_SERVERCAPABILITIES:
			{
				array->size+=4;
				...
				break;
			case UserAuthorizationAnswer_ERRORMESSAGE:
			{
					array->size+=4;
				...
				break;
			case UserAuthorizationAnswer_FAILEDAVP:
			{
				array->size+=4;
				...
				break;
			case UserAuthorizationAnswer_PROXYINFO:
			{
				if( mProxyInfoGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case UserAuthorizationAnswer_ROUTERECORD:
			{
...
int UserAuthorizationAnswer::Decode(byteArray *array, INT16 lMLen, UINT16 *parsedBytes)
{
...
DiameterBaseInterface* UserAuthorizationAnswer::Find(byteArray *array, UINT32 avpCode)
{
...
BOOLEAN UserAuthorizationAnswer::FindAll(byteArray *array, UINT32 avpCode, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
std::shared_ptr<byteArray> UserAuthorizationAnswer::GetByteArray()
{
	return mspByteArray;
}


BOOLEAN UserAuthorizationAnswer::FindAll(byteArray *array, std::map<int,UINT32> &avpCodeMap, int &size, int key, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
void UserAuthorizationAnswer::Display(UINT32 tab)
{
...
BOOLEAN UserAuthorizationAnswer::GetMissingAvpInfo(TEXT *lMissingAvpInfo)
{
