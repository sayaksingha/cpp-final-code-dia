...
Unsigned32* VendorSpecificApplicationId::setAuthApplicationId(){
	mMandatoryAvpSetVal [VendorSpecificApplicationId_AUTHAPPLICATIONID] = 1;
	if(mAuthApplicationId == NULL)
	{
		mAuthApplicationId = new Unsigned32();
...
Unsigned32* VendorSpecificApplicationId::getAuthApplicationId(){
			...
			case 258:
				{
					...
					mAuthApplicationId->SetDataType((DiameterDataType)3);
