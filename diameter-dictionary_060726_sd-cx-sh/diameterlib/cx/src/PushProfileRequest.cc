...
using namespace CX;
BOOLEAN PushProfileRequest::isPresent(int tag){
...
PushProfileRequest::PushProfileRequest()
{
	...
	mSIPAuthDataItemGrp = NULL;
	mAllowedWAFWWSFIdentitiesGrp = NULL;
	mProxyInfoGrpList = NULL;
	mRouteRecordList = NULL;
	mTagsPresent.reset();
	mMandatoryAvpCheckVal= bitset<16>(string("1101110111111101"));
...
PushProfileRequest::~PushProfileRequest()
{
	...
	if(mSIPAuthDataItemGrp != NULL)
		delete mSIPAuthDataItemGrp;
...
OctetString* PushProfileRequest::setSessionId(){
	mMandatoryAvpSetVal [PushProfileRequest_SESSIONID] = 1;
	if(mSessionId == NULL)
	{
		mSessionId = new OctetString();
		mTagsPresent[PushProfileRequest_SESSIONID] = 1;
		return mSessionId;
	}
	return mSessionId;
}

void PushProfileRequest::resetSessionId(){
	mTagsPresent[PushProfileRequest_SESSIONID] = 0;
	if(mSessionId != NULL)
	{
		delete mSessionId; 
		mSessionId = NULL;
...
DRMP* PushProfileRequest::setDRMP(){
	if(mDRMP == NULL)
	{
		mDRMP = new DRMP();
		mTagsPresent[PushProfileRequest_DRMP] = 1;
		return mDRMP;
	}
	return mDRMP;
}

void PushProfileRequest::resetDRMP(){
	mTagsPresent[PushProfileRequest_DRMP] = 0;
	if(mDRMP != NULL)
	{
		delete mDRMP; 
		mDRMP = NULL;
...
AuthSessionState* PushProfileRequest::setAuthSessionState(){
	mMandatoryAvpSetVal [PushProfileRequest_AUTHSESSIONSTATE] = 1;
	if(mAuthSessionState == NULL)
	{
		mAuthSessionState = new AuthSessionState();
		mTagsPresent[PushProfileRequest_AUTHSESSIONSTATE] = 1;
		return mAuthSessionState;
	}
	return mAuthSessionState;
}

void PushProfileRequest::resetAuthSessionState(){
	mTagsPresent[PushProfileRequest_AUTHSESSIONSTATE] = 0;
	if(mAuthSessionState != NULL)
	{
		delete mAuthSessionState; 
		mAuthSessionState = NULL;
...
OctetString* PushProfileRequest::setOriginHost(){
	mMandatoryAvpSetVal [PushProfileRequest_ORIGINHOST] = 1;
	if(mOriginHost == NULL)
	{
		mOriginHost = new OctetString();
		mTagsPresent[PushProfileRequest_ORIGINHOST] = 1;
		return mOriginHost;
	}
	return mOriginHost;
}

void PushProfileRequest::resetOriginHost(){
	mTagsPresent[PushProfileRequest_ORIGINHOST] = 0;
	if(mOriginHost != NULL)
	{
		delete mOriginHost; 
		mOriginHost = NULL;
...
OctetString* PushProfileRequest::setOriginRealm(){
	mMandatoryAvpSetVal [PushProfileRequest_ORIGINREALM] = 1;
	if(mOriginRealm == NULL)
	{
		mOriginRealm = new OctetString();
		mTagsPresent[PushProfileRequest_ORIGINREALM] = 1;
		return mOriginRealm;
	}
	return mOriginRealm;
}

void PushProfileRequest::resetOriginRealm(){
	mTagsPresent[PushProfileRequest_ORIGINREALM] = 0;
	if(mOriginRealm != NULL)
	{
		delete mOriginRealm; 
		mOriginRealm = NULL;
...
OctetString* PushProfileRequest::setDestinationHost(){
	mMandatoryAvpSetVal [PushProfileRequest_DESTINATIONHOST] = 1;
	if(mDestinationHost == NULL)
	{
		mDestinationHost = new OctetString();
		mTagsPresent[PushProfileRequest_DESTINATIONHOST] = 1;
		return mDestinationHost;
	}
	return mDestinationHost;
}

void PushProfileRequest::resetDestinationHost(){
	mTagsPresent[PushProfileRequest_DESTINATIONHOST] = 0;
	if(mDestinationHost != NULL)
	{
		delete mDestinationHost; 
		mDestinationHost = NULL;
...
OctetString* PushProfileRequest::setDestinationRealm(){
	mMandatoryAvpSetVal [PushProfileRequest_DESTINATIONREALM] = 1;
	if(mDestinationRealm == NULL)
	{
		mDestinationRealm = new OctetString();
		mTagsPresent[PushProfileRequest_DESTINATIONREALM] = 1;
		return mDestinationRealm;
	}
	return mDestinationRealm;
}

void PushProfileRequest::resetDestinationRealm(){
	mTagsPresent[PushProfileRequest_DESTINATIONREALM] = 0;
	if(mDestinationRealm != NULL)
	{
		delete mDestinationRealm; 
		mDestinationRealm = NULL;
...
OctetString* PushProfileRequest::setUserName(){
	mMandatoryAvpSetVal [PushProfileRequest_USERNAME] = 1;
	if(mUserName == NULL)
	{
		mUserName = new OctetString();
		mTagsPresent[PushProfileRequest_USERNAME] = 1;
		return mUserName;
	}
	return mUserName;
}

void PushProfileRequest::resetUserName(){
	mTagsPresent[PushProfileRequest_USERNAME] = 0;
	if(mUserName != NULL)
	{
		delete mUserName; 
		mUserName = NULL;
...
OctetString* PushProfileRequest::setUserData(){
	mMandatoryAvpSetVal [PushProfileRequest_USERDATA] = 1;
	if(mUserData == NULL)
	{
		mUserData = new OctetString();
		mTagsPresent[PushProfileRequest_USERDATA] = 1;
		return mUserData;
	}
	return mUserData;
}

void PushProfileRequest::resetUserData(){
	mTagsPresent[PushProfileRequest_USERDATA] = 0;
	if(mUserData != NULL)
	{
		delete mUserData; 
		mUserData = NULL;
...
OctetString* PushProfileRequest::getSessionId(){
	if(NULL == mSessionId) {
...
DRMP* PushProfileRequest::getDRMP(){
	if(NULL == mDRMP) {
...
CX::VendorSpecificApplicationId* PushProfileRequest::getVendorSpecificApplicationId()
{
	if(mVendorSpecificApplicationIdGrp == NULL)
	{
...
CX::VendorSpecificApplicationId* PushProfileRequest::setVendorSpecificApplicationId(){
	if(mVendorSpecificApplicationIdGrp == NULL)
		mVendorSpecificApplicationIdGrp = new VendorSpecificApplicationId();
	mTagsPresent[PushProfileRequest_VENDORSPECIFICAPPLICATIONID] = 1;
	mMandatoryAvpSetVal[PushProfileRequest_VENDORSPECIFICAPPLICATIONID] = 1;
	return mVendorSpecificApplicationIdGrp;
}

void PushProfileRequest::resetVendorSpecificApplicationId(){
	mTagsPresent[PushProfileRequest_VENDORSPECIFICAPPLICATIONID] = 0;
	if(mVendorSpecificApplicationIdGrp != NULL)
		delete mVendorSpecificApplicationIdGrp;
}

AuthSessionState* PushProfileRequest::getAuthSessionState(){
...
OctetString* PushProfileRequest::getOriginHost(){
	if(NULL == mOriginHost) {
...
OctetString* PushProfileRequest::getOriginRealm(){
...
OctetString* PushProfileRequest::getDestinationHost(){
...
OctetString* PushProfileRequest::getDestinationRealm(){
...
OctetString* PushProfileRequest::getUserName(){
	if(NULL == mUserName) {
...
list<SupportedFeatures*>* PushProfileRequest::getSupportedFeaturesGrpList()
{
	if(mSupportedFeaturesGrpList == NULL)
	{
	...
	for(auto itr : *mSupportedFeaturesGrpList)
	{
		...
		{
			mTagsPresent[PushProfileRequest_SUPPORTEDFEATURES] = 0;
			mSupportedFeaturesGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "SupportedFeatures is Null");
			throw lTssDiaMsgException;
		}
...
list<SupportedFeatures*>* PushProfileRequest::setSupportedFeaturesGrpList(){
	mTagsPresent[PushProfileRequest_SUPPORTEDFEATURES] = 1;
	if(mSupportedFeaturesGrpList == NULL)
...
void PushProfileRequest::resetSupportedFeaturesGrpList(){
	mTagsPresent[PushProfileRequest_SUPPORTEDFEATURES] = 0;
	if(mSupportedFeaturesGrpList != NULL)
		delete mSupportedFeaturesGrpList;
}

OctetString* PushProfileRequest::getUserData(){
	if(NULL == mUserData) {
...
ChargingInformation* PushProfileRequest::getChargingInformation()
{
	if(mChargingInformationGrp == NULL)
	{
...
ChargingInformation* PushProfileRequest::setChargingInformation(){
	if(mChargingInformationGrp == NULL)
		mChargingInformationGrp = new ChargingInformation();
	mTagsPresent[PushProfileRequest_CHARGINGINFORMATION] = 1;
	mMandatoryAvpSetVal[PushProfileRequest_CHARGINGINFORMATION] = 1;
	return mChargingInformationGrp;
}

void PushProfileRequest::resetChargingInformation(){
	mTagsPresent[PushProfileRequest_CHARGINGINFORMATION] = 0;
	if(mChargingInformationGrp != NULL)
		delete mChargingInformationGrp;
}

SIPAuthDataItem* PushProfileRequest::getSIPAuthDataItem()
{
	if(mSIPAuthDataItemGrp == NULL)
	{
	...
	if(!mSIPAuthDataItemGrp->mAvpDecodedFlag)
	{
			if(mspByteArray.get() == NULL)
			{
			mSIPAuthDataItemGrp->mAvpDecodedFlag = true;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "SIPAuthDataItem is Null");
			throw lTssDiaMsgException;
			}
		mspByteArray.get()->offset = 0;
		mspByteArray.get()->offset = mSIPAuthDataItemGrp->getAvpOffsetLen().first;
		UINT16 lBytesDecoded = 0;
		if(mSIPAuthDataItemGrp->Decode(mspByteArray.get(), mSIPAuthDataItemGrp->getAvpOffsetLen().second, &lBytesDecoded)< 0)
		{
	...
	return mSIPAuthDataItemGrp;
}

SIPAuthDataItem* PushProfileRequest::setSIPAuthDataItem(){
	if(mSIPAuthDataItemGrp == NULL)
		mSIPAuthDataItemGrp = new SIPAuthDataItem();
	mTagsPresent[PushProfileRequest_SIPAUTHDATAITEM] = 1;
	mMandatoryAvpSetVal[PushProfileRequest_SIPAUTHDATAITEM] = 1;
	return mSIPAuthDataItemGrp;
}

void PushProfileRequest::resetSIPAuthDataItem(){
	mTagsPresent[PushProfileRequest_SIPAUTHDATAITEM] = 0;
	if(mSIPAuthDataItemGrp != NULL)
		delete mSIPAuthDataItemGrp;
}

AllowedWAFWWSFIdentities* PushProfileRequest::getAllowedWAFWWSFIdentities()
{
	if(mAllowedWAFWWSFIdentitiesGrp == NULL)
	{
...
AllowedWAFWWSFIdentities* PushProfileRequest::setAllowedWAFWWSFIdentities(){
	if(mAllowedWAFWWSFIdentitiesGrp == NULL)
		mAllowedWAFWWSFIdentitiesGrp = new AllowedWAFWWSFIdentities();
	mTagsPresent[PushProfileRequest_ALLOWEDWAFWWSFIDENTITIES] = 1;
	return mAllowedWAFWWSFIdentitiesGrp;
}

void PushProfileRequest::resetAllowedWAFWWSFIdentities(){
	mTagsPresent[PushProfileRequest_ALLOWEDWAFWWSFIDENTITIES] = 0;
	if(mAllowedWAFWWSFIdentitiesGrp != NULL)
		delete mAllowedWAFWWSFIdentitiesGrp;
}

list<CX::ProxyInfo*>* PushProfileRequest::getProxyInfoGrpList()
{
	if(mProxyInfoGrpList == NULL)
	{
	...
	for(auto itr : *mProxyInfoGrpList)
	{
		...
		{
			mTagsPresent[PushProfileRequest_PROXYINFO] = 0;
			mProxyInfoGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "ProxyInfo is Null");
			throw lTssDiaMsgException;
		}
...
list<CX::ProxyInfo*>* PushProfileRequest::setProxyInfoGrpList(){
	mTagsPresent[PushProfileRequest_PROXYINFO] = 1;
	if(mProxyInfoGrpList == NULL)
		mProxyInfoGrpList = new list<CX::ProxyInfo*>;
	mMandatoryAvpSetVal[PushProfileRequest_PROXYINFO] = 1;
	mProxyInfoGrpList->clear();
	return mProxyInfoGrpList;
}

void PushProfileRequest::resetProxyInfoGrpList(){
	mTagsPresent[PushProfileRequest_PROXYINFO] = 0;
	if(mProxyInfoGrpList != NULL)
		delete mProxyInfoGrpList;
}

list<OctetString*>* PushProfileRequest::getRouteRecordList()
{
	if(mRouteRecordList == NULL)
	{
...
list<OctetString*>* PushProfileRequest::setRouteRecordList() {
	mTagsPresent[PushProfileRequest_ROUTERECORD] = 1;
	if(mRouteRecordList == NULL)
		mRouteRecordList = new list<OctetString*>;
	mMandatoryAvpSetVal [PushProfileRequest_ROUTERECORD] = 1;
	mRouteRecordList->clear();
	return mRouteRecordList;
}

void PushProfileRequest::resetRouteRecordList(){
	mTagsPresent[PushProfileRequest_ROUTERECORD] = 0;
	if(mRouteRecordList != NULL)
		delete mRouteRecordList;
}
...
int PushProfileRequest::Encode(byteArray *array)
{
	...
	array->byte[array->offset++] = (305>>16) & 0xFF;
	array->byte[array->offset++] = (305>>8) & 0xFF;
	array->byte[array->offset++] = (305) & 0xFF;
	...
	for(unsigned int i = 0 ; i < mTagsPresent.size() ; ++i )
	{
		...
		switch(i)
		{
			case PushProfileRequest_SESSIONID:
			{
					array->size+=4;
			...
			case PushProfileRequest_DRMP:
			{
				...
				break;
			case PushProfileRequest_VENDORSPECIFICAPPLICATIONID:
			{
				array->size+=4;
				...
				break;
			case PushProfileRequest_AUTHSESSIONSTATE:
			{
					array->size+=4;
				...
				break;
			case PushProfileRequest_ORIGINHOST:
			{
					array->size+=4;
				...
				break;
			case PushProfileRequest_ORIGINREALM:
			{
					array->size+=4;
				...
				break;
			case PushProfileRequest_DESTINATIONHOST:
			{
					array->size+=4;
				...
				break;
			case PushProfileRequest_DESTINATIONREALM:
			{
					array->size+=4;
				...
				break;
			case PushProfileRequest_USERNAME:
			{
					array->size+=4;
				...
				break;
			case PushProfileRequest_SUPPORTEDFEATURES:
			{
				if( mSupportedFeaturesGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case PushProfileRequest_USERDATA:
			{
					array->size+=4;
				...
				break;
			case PushProfileRequest_CHARGINGINFORMATION:
			{
				array->size+=4;
				...
				break;
			case PushProfileRequest_SIPAUTHDATAITEM:
			{
				array->size+=4;
				...
				if((this->getSIPAuthDataItem()->Encode(array) < 0) || 
						(DiameterTLVUtil::avp_length_encode(lengthOffset, array) == false)) {
				...
				break;
			case PushProfileRequest_ALLOWEDWAFWWSFIDENTITIES:
			{
				array->size+=4;
				...
				break;
			case PushProfileRequest_PROXYINFO:
			{
				if( mProxyInfoGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case PushProfileRequest_ROUTERECORD:
			{
...
int PushProfileRequest::Decode(byteArray *array, INT16 lMLen, UINT16 *parsedBytes)
{
			...
			case 612:
				{
						mMandatoryAvpSetVal [PushProfileRequest_SIPAUTHDATAITEM] = 1;
					mTagsPresent[PushProfileRequest_SIPAUTHDATAITEM] = 1;
						if( NULL == this->setSIPAuthDataItem()){
						mDecodeFlag = false;
						TssDiameterMsgException lTssDiaMsgException(DIAMETER_ERR_DECODE,"Error decoding SIPAuthDataItem");
						throw lTssDiaMsgException;
						}
					mSIPAuthDataItemGrp->setAvpCode(612);
					mSIPAuthDataItemGrp->SetDataType((DiameterDataType)6);
					mSIPAuthDataItemGrp->mspByteArray = mspByteArray;
					mSIPAuthDataItemGrp->mAvpDecodedFlag = false;
					mSIPAuthDataItemGrp->setAvpOffsetLen(array->offset,lAvpDataLen);
					mBaseInterfaceList.push_back(mSIPAuthDataItemGrp);
					array->offset+=lAvpDataLen;
...
DiameterBaseInterface* PushProfileRequest::Find(byteArray *array, UINT32 avpCode)
{
...
BOOLEAN PushProfileRequest::FindAll(byteArray *array, UINT32 avpCode, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
		...
		switch(avpCode)
		{
			...
			case 612:
			{
				if(mSIPAuthDataItemGrp != NULL)
				{
						pBaseInterface.push_back(mSIPAuthDataItemGrp);
				}
				if(deepInspect)
				{
					for(auto itr = mBaseInterfaceList.begin(); itr != mBaseInterfaceList.end(); ++itr)
...
std::shared_ptr<byteArray> PushProfileRequest::GetByteArray()
{
	return mspByteArray;
}


BOOLEAN PushProfileRequest::FindAll(byteArray *array, std::map<int,UINT32> &avpCodeMap, int &size, int key, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
		...
		switch(avpCode)
		{
			...
			case 612:
			{
				...
				if(deepInspect)
				{
					for(auto itr = mBaseInterfaceList.begin(); itr != mBaseInterfaceList.end(); ++itr)
					{
						mSIPAuthDataItemGrp->FindAll(this->mspByteArray.get(), avpCodeMap, size, (key+1),  pBaseInterface,deepInspect);
					}
				}
				}
				break;
...
void PushProfileRequest::Display(UINT32 tab)
{
	...
	for(int i = 0; i < mTagsPresent.size() ; ++i)
	{
		...
		switch(i)
		{
			...
			case PushProfileRequest_SIPAUTHDATAITEM:
			{
				...
				//Hardcoded value.;
				sprintf( lAvpFlg, "%s %s %s", ((DiameterTLVUtil::isVenderSpecific(192)==true)?"Vendor":""), ((DiameterTLVUtil::isMandatoryBitSet(192)==true)?"Mandatory":""), ((DiameterTLVUtil::isProtectedBitSet(192)==true)?"Protected":""));
				this->getSIPAuthDataItem()->Display(tab+1);
			}
				break;
			case PushProfileRequest_ALLOWEDWAFWWSFIDENTITIES:
			{
...
BOOLEAN PushProfileRequest::GetMissingAvpInfo(TEXT *lMissingAvpInfo)
{
