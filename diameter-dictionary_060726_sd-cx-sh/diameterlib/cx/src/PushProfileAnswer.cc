...
using namespace CX;
BOOLEAN PushProfileAnswer::isPresent(int tag){
...
PushProfileAnswer::PushProfileAnswer()
{
	...
	mTagsPresent.reset();
	mMandatoryAvpCheckVal= bitset<13>(string("1110011111101"));
...
OctetString* PushProfileAnswer::setSessionId(){
	mMandatoryAvpSetVal [PushProfileAnswer_SESSIONID] = 1;
	if(mSessionId == NULL)
	{
		mSessionId = new OctetString();
		mTagsPresent[PushProfileAnswer_SESSIONID] = 1;
		return mSessionId;
	}
	return mSessionId;
}

void PushProfileAnswer::resetSessionId(){
	mTagsPresent[PushProfileAnswer_SESSIONID] = 0;
	if(mSessionId != NULL)
	{
		delete mSessionId; 
		mSessionId = NULL;
...
DRMP* PushProfileAnswer::setDRMP(){
	if(mDRMP == NULL)
	{
		mDRMP = new DRMP();
		mTagsPresent[PushProfileAnswer_DRMP] = 1;
		return mDRMP;
	}
	return mDRMP;
}

void PushProfileAnswer::resetDRMP(){
	mTagsPresent[PushProfileAnswer_DRMP] = 0;
	if(mDRMP != NULL)
	{
		delete mDRMP; 
		mDRMP = NULL;
...
Unsigned32* PushProfileAnswer::setResultCode(){
	mMandatoryAvpSetVal [PushProfileAnswer_RESULTCODE] = 1;
	if(mResultCode == NULL)
	{
		mResultCode = new Unsigned32();
		mTagsPresent[PushProfileAnswer_RESULTCODE] = 1;
		return mResultCode;
	}
	return mResultCode;
}

void PushProfileAnswer::resetResultCode(){
	mTagsPresent[PushProfileAnswer_RESULTCODE] = 0;
	if(mResultCode != NULL)
	{
		delete mResultCode; 
		mResultCode = NULL;
...
AuthSessionState* PushProfileAnswer::setAuthSessionState(){
	mMandatoryAvpSetVal [PushProfileAnswer_AUTHSESSIONSTATE] = 1;
	if(mAuthSessionState == NULL)
	{
		mAuthSessionState = new AuthSessionState();
		mTagsPresent[PushProfileAnswer_AUTHSESSIONSTATE] = 1;
		return mAuthSessionState;
	}
	return mAuthSessionState;
}

void PushProfileAnswer::resetAuthSessionState(){
	mTagsPresent[PushProfileAnswer_AUTHSESSIONSTATE] = 0;
	if(mAuthSessionState != NULL)
	{
		delete mAuthSessionState; 
		mAuthSessionState = NULL;
...
OctetString* PushProfileAnswer::setOriginHost(){
	mMandatoryAvpSetVal [PushProfileAnswer_ORIGINHOST] = 1;
	if(mOriginHost == NULL)
	{
		mOriginHost = new OctetString();
		mTagsPresent[PushProfileAnswer_ORIGINHOST] = 1;
		return mOriginHost;
	}
	return mOriginHost;
}

void PushProfileAnswer::resetOriginHost(){
	mTagsPresent[PushProfileAnswer_ORIGINHOST] = 0;
	if(mOriginHost != NULL)
	{
		delete mOriginHost; 
		mOriginHost = NULL;
...
OctetString* PushProfileAnswer::setOriginRealm(){
	mMandatoryAvpSetVal [PushProfileAnswer_ORIGINREALM] = 1;
	if(mOriginRealm == NULL)
	{
		mOriginRealm = new OctetString();
		mTagsPresent[PushProfileAnswer_ORIGINREALM] = 1;
		return mOriginRealm;
	}
	return mOriginRealm;
}

void PushProfileAnswer::resetOriginRealm(){
	mTagsPresent[PushProfileAnswer_ORIGINREALM] = 0;
	if(mOriginRealm != NULL)
	{
		delete mOriginRealm; 
		mOriginRealm = NULL;
...
OctetString* PushProfileAnswer::setErrorMessage(){
	if(mErrorMessage == NULL)
	{
		mErrorMessage = new OctetString();
		mTagsPresent[PushProfileAnswer_ERRORMESSAGE] = 1;
		return mErrorMessage;
	}
	return mErrorMessage;
}

void PushProfileAnswer::resetErrorMessage(){
	mTagsPresent[PushProfileAnswer_ERRORMESSAGE] = 0;
	if(mErrorMessage != NULL)
	{
		delete mErrorMessage; 
		mErrorMessage = NULL;
...
OctetString* PushProfileAnswer::getSessionId(){
	if(NULL == mSessionId) {
...
DRMP* PushProfileAnswer::getDRMP(){
	if(NULL == mDRMP) {
...
CX::VendorSpecificApplicationId* PushProfileAnswer::getVendorSpecificApplicationId()
{
	if(mVendorSpecificApplicationIdGrp == NULL)
	{
...
CX::VendorSpecificApplicationId* PushProfileAnswer::setVendorSpecificApplicationId(){
	if(mVendorSpecificApplicationIdGrp == NULL)
		mVendorSpecificApplicationIdGrp = new VendorSpecificApplicationId();
	mTagsPresent[PushProfileAnswer_VENDORSPECIFICAPPLICATIONID] = 1;
	mMandatoryAvpSetVal[PushProfileAnswer_VENDORSPECIFICAPPLICATIONID] = 1;
	return mVendorSpecificApplicationIdGrp;
}

void PushProfileAnswer::resetVendorSpecificApplicationId(){
	mTagsPresent[PushProfileAnswer_VENDORSPECIFICAPPLICATIONID] = 0;
	if(mVendorSpecificApplicationIdGrp != NULL)
		delete mVendorSpecificApplicationIdGrp;
}

Unsigned32* PushProfileAnswer::getResultCode(){
	if(NULL == mResultCode) {
...
ExperimentalResult* PushProfileAnswer::getExperimentalResult()
{
	if(mExperimentalResultGrp == NULL)
	{
...
ExperimentalResult* PushProfileAnswer::setExperimentalResult(){
	if(mExperimentalResultGrp == NULL)
		mExperimentalResultGrp = new ExperimentalResult();
	mTagsPresent[PushProfileAnswer_EXPERIMENTALRESULT] = 1;
	mMandatoryAvpSetVal[PushProfileAnswer_EXPERIMENTALRESULT] = 1;
	return mExperimentalResultGrp;
}

void PushProfileAnswer::resetExperimentalResult(){
	mTagsPresent[PushProfileAnswer_EXPERIMENTALRESULT] = 0;
	if(mExperimentalResultGrp != NULL)
		delete mExperimentalResultGrp;
}

AuthSessionState* PushProfileAnswer::getAuthSessionState(){
...
OctetString* PushProfileAnswer::getOriginHost(){
	if(NULL == mOriginHost) {
...
OctetString* PushProfileAnswer::getOriginRealm(){
...
list<SupportedFeatures*>* PushProfileAnswer::getSupportedFeaturesGrpList()
{
	if(mSupportedFeaturesGrpList == NULL)
	{
	...
	for(auto itr : *mSupportedFeaturesGrpList)
	{
		...
		{
			mTagsPresent[PushProfileAnswer_SUPPORTEDFEATURES] = 0;
			mSupportedFeaturesGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "SupportedFeatures is Null");
			throw lTssDiaMsgException;
		}
...
list<SupportedFeatures*>* PushProfileAnswer::setSupportedFeaturesGrpList(){
	mTagsPresent[PushProfileAnswer_SUPPORTEDFEATURES] = 1;
	if(mSupportedFeaturesGrpList == NULL)
...
void PushProfileAnswer::resetSupportedFeaturesGrpList(){
	mTagsPresent[PushProfileAnswer_SUPPORTEDFEATURES] = 0;
	if(mSupportedFeaturesGrpList != NULL)
		delete mSupportedFeaturesGrpList;
}

OctetString* PushProfileAnswer::getErrorMessage(){
...
FailedAVP* PushProfileAnswer::getFailedAVP()
{
	if(mFailedAVPGrp == NULL)
	{
...
FailedAVP* PushProfileAnswer::setFailedAVP(){
	if(mFailedAVPGrp == NULL)
		mFailedAVPGrp = new FailedAVP();
	mTagsPresent[PushProfileAnswer_FAILEDAVP] = 1;
	mMandatoryAvpSetVal[PushProfileAnswer_FAILEDAVP] = 1;
	return mFailedAVPGrp;
}

void PushProfileAnswer::resetFailedAVP(){
	mTagsPresent[PushProfileAnswer_FAILEDAVP] = 0;
	if(mFailedAVPGrp != NULL)
		delete mFailedAVPGrp;
}

list<CX::ProxyInfo*>* PushProfileAnswer::getProxyInfoGrpList()
{
	if(mProxyInfoGrpList == NULL)
	{
	...
	for(auto itr : *mProxyInfoGrpList)
	{
		...
		{
			mTagsPresent[PushProfileAnswer_PROXYINFO] = 0;
			mProxyInfoGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "ProxyInfo is Null");
			throw lTssDiaMsgException;
		}
...
list<CX::ProxyInfo*>* PushProfileAnswer::setProxyInfoGrpList(){
	mTagsPresent[PushProfileAnswer_PROXYINFO] = 1;
	if(mProxyInfoGrpList == NULL)
		mProxyInfoGrpList = new list<CX::ProxyInfo*>;
	mMandatoryAvpSetVal[PushProfileAnswer_PROXYINFO] = 1;
	mProxyInfoGrpList->clear();
	return mProxyInfoGrpList;
}

void PushProfileAnswer::resetProxyInfoGrpList(){
	mTagsPresent[PushProfileAnswer_PROXYINFO] = 0;
	if(mProxyInfoGrpList != NULL)
		delete mProxyInfoGrpList;
}

list<OctetString*>* PushProfileAnswer::getRouteRecordList()
{
	if(mRouteRecordList == NULL)
	{
...
list<OctetString*>* PushProfileAnswer::setRouteRecordList() {
	mTagsPresent[PushProfileAnswer_ROUTERECORD] = 1;
	if(mRouteRecordList == NULL)
		mRouteRecordList = new list<OctetString*>;
	mMandatoryAvpSetVal [PushProfileAnswer_ROUTERECORD] = 1;
	mRouteRecordList->clear();
	return mRouteRecordList;
}

void PushProfileAnswer::resetRouteRecordList(){
	mTagsPresent[PushProfileAnswer_ROUTERECORD] = 0;
	if(mRouteRecordList != NULL)
		delete mRouteRecordList;
}
...
int PushProfileAnswer::Encode(byteArray *array)
{
	...
	for(unsigned int i = 0 ; i < mTagsPresent.size() ; ++i )
	{
		...
		switch(i)
		{
			case PushProfileAnswer_SESSIONID:
			{
					array->size+=4;
			...
			case PushProfileAnswer_DRMP:
			{
				...
				break;
			case PushProfileAnswer_VENDORSPECIFICAPPLICATIONID:
			{
				array->size+=4;
				...
				break;
			case PushProfileAnswer_RESULTCODE:
			{
					array->size+=4;
				...
				break;
			case PushProfileAnswer_EXPERIMENTALRESULT:
			{
				array->size+=4;
				...
				break;
			case PushProfileAnswer_AUTHSESSIONSTATE:
			{
					array->size+=4;
				...
				break;
			case PushProfileAnswer_ORIGINHOST:
			{
					array->size+=4;
				...
				break;
			case PushProfileAnswer_ORIGINREALM:
			{
					array->size+=4;
				...
				break;
			case PushProfileAnswer_SUPPORTEDFEATURES:
			{
				if( mSupportedFeaturesGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case PushProfileAnswer_ERRORMESSAGE:
			{
					array->size+=4;
				...
				break;
			case PushProfileAnswer_FAILEDAVP:
			{
				array->size+=4;
				...
				break;
			case PushProfileAnswer_PROXYINFO:
			{
				if( mProxyInfoGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case PushProfileAnswer_ROUTERECORD:
			{
...
int PushProfileAnswer::Decode(byteArray *array, INT16 lMLen, UINT16 *parsedBytes)
{
...
DiameterBaseInterface* PushProfileAnswer::Find(byteArray *array, UINT32 avpCode)
{
...
BOOLEAN PushProfileAnswer::FindAll(byteArray *array, UINT32 avpCode, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
std::shared_ptr<byteArray> PushProfileAnswer::GetByteArray()
{
	return mspByteArray;
}


BOOLEAN PushProfileAnswer::FindAll(byteArray *array, std::map<int,UINT32> &avpCodeMap, int &size, int key, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
void PushProfileAnswer::Display(UINT32 tab)
{
...
BOOLEAN PushProfileAnswer::GetMissingAvpInfo(TEXT *lMissingAvpInfo)
{
