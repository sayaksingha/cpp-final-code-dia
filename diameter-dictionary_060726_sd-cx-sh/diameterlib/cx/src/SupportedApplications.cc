#include "cx/include/SupportedApplications.h"
...
list<CX::VendorSpecificApplicationId*>* SupportedApplications::getVendorSpecificApplicationIdGrpList()
{
	if(mVendorSpecificApplicationIdGrpList == NULL)
	{
...
list<CX::VendorSpecificApplicationId*>* SupportedApplications::setVendorSpecificApplicationIdGrpList(){
	mTagsPresent[SupportedApplications_VENDORSPECIFICAPPLICATIONID] = 1;
	if(mVendorSpecificApplicationIdGrpList == NULL)
		mVendorSpecificApplicationIdGrpList = new list<CX::VendorSpecificApplicationId*>;
