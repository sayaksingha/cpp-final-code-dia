#ifndef BASE_VENDORSPECIFICAPPLICATIONID_H
#define BASE_VENDORSPECIFICAPPLICATIONID_H
...
class VendorSpecificApplicationId : public DiameterBaseInterface
{
	...
	public:
		...
		mVendorId = new Integer32(*(objVendorSpecificApplicationId.mVendorId));

		if(objVendorSpecificApplicationId.mAuthApplicationId != NULL)
		mAuthApplicationId = new Integer32(*(objVendorSpecificApplicationId.mAuthApplicationId));
		...
		/*!		Function to set the recent Integer32 type of argument VendorId for datatype VendorSpecificApplicationId
		*/
		...
		*/
		...
		/*!		Function to get Integer32 type of argument VendorId for datatype VendorSpecificApplicationId
		Throws exception of which type and Summary of Exception
		*/
		Integer32* getVendorId();

		//!Function to set values
		/*!		Function to set the recent Integer32 type of argument AuthApplicationId for datatype VendorSpecificApplicationId
		*/
		...
		*/
		...
		//!Function to get values
		/*!		Function to get Integer32 type of argument AuthApplicationId for datatype VendorSpecificApplicationId
		Throws exception of which type and Summary of Exception
		*/
