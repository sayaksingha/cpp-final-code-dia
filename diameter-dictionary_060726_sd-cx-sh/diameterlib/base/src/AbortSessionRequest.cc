...
BOOLEAN AbortSessionRequest::isPresent(int tag){
...
AbortSessionRequest::AbortSessionRequest()
{
	...
	mCCRequestType = NULL;
	mTagsPresent.reset();
	mMandatoryAvpCheckVal= bitset<11>(string("11111111111"));
...
OctetString* AbortSessionRequest::setSessionId(){
	mMandatoryAvpSetVal [AbortSessionRequest_SESSIONID] = 1;
	if(mSessionId == NULL)
	{
		mSessionId = new OctetString();
		mTagsPresent[AbortSessionRequest_SESSIONID] = 1;
		return mSessionId;
	}
	return mSessionId;
}

void AbortSessionRequest::resetSessionId(){
	mTagsPresent[AbortSessionRequest_SESSIONID] = 0;
	if(mSessionId != NULL)
	{
		delete mSessionId; 
		mSessionId = NULL;
...
OctetString* AbortSessionRequest::setOriginHost(){
	mMandatoryAvpSetVal [AbortSessionRequest_ORIGINHOST] = 1;
	if(mOriginHost == NULL)
	{
		mOriginHost = new OctetString();
		mTagsPresent[AbortSessionRequest_ORIGINHOST] = 1;
		return mOriginHost;
	}
	return mOriginHost;
}

void AbortSessionRequest::resetOriginHost(){
	mTagsPresent[AbortSessionRequest_ORIGINHOST] = 0;
	if(mOriginHost != NULL)
	{
		delete mOriginHost; 
		mOriginHost = NULL;
...
OctetString* AbortSessionRequest::setOriginRealm(){
	mMandatoryAvpSetVal [AbortSessionRequest_ORIGINREALM] = 1;
	if(mOriginRealm == NULL)
	{
		mOriginRealm = new OctetString();
		mTagsPresent[AbortSessionRequest_ORIGINREALM] = 1;
		return mOriginRealm;
	}
	return mOriginRealm;
}

void AbortSessionRequest::resetOriginRealm(){
	mTagsPresent[AbortSessionRequest_ORIGINREALM] = 0;
	if(mOriginRealm != NULL)
	{
		delete mOriginRealm; 
		mOriginRealm = NULL;
...
Unsigned32* AbortSessionRequest::setOriginStateId(){
	mMandatoryAvpSetVal [AbortSessionRequest_ORIGINSTATEID] = 1;
	if(mOriginStateId == NULL)
	{
		mOriginStateId = new Unsigned32();
		mTagsPresent[AbortSessionRequest_ORIGINSTATEID] = 1;
		return mOriginStateId;
	}
	return mOriginStateId;
}

void AbortSessionRequest::resetOriginStateId(){
	mTagsPresent[AbortSessionRequest_ORIGINSTATEID] = 0;
	if(mOriginStateId != NULL)
	{
		delete mOriginStateId; 
		mOriginStateId = NULL;
...
OctetString* AbortSessionRequest::setDestinationRealm(){
	mMandatoryAvpSetVal [AbortSessionRequest_DESTINATIONREALM] = 1;
	if(mDestinationRealm == NULL)
	{
		mDestinationRealm = new OctetString();
		mTagsPresent[AbortSessionRequest_DESTINATIONREALM] = 1;
		return mDestinationRealm;
	}
	return mDestinationRealm;
}

void AbortSessionRequest::resetDestinationRealm(){
	mTagsPresent[AbortSessionRequest_DESTINATIONREALM] = 0;
	if(mDestinationRealm != NULL)
	{
		delete mDestinationRealm; 
		mDestinationRealm = NULL;
...
OctetString* AbortSessionRequest::setDestinationHost(){
	mMandatoryAvpSetVal [AbortSessionRequest_DESTINATIONHOST] = 1;
	if(mDestinationHost == NULL)
	{
		mDestinationHost = new OctetString();
		mTagsPresent[AbortSessionRequest_DESTINATIONHOST] = 1;
		return mDestinationHost;
	}
	return mDestinationHost;
}

void AbortSessionRequest::resetDestinationHost(){
	mTagsPresent[AbortSessionRequest_DESTINATIONHOST] = 0;
	if(mDestinationHost != NULL)
	{
		delete mDestinationHost; 
		mDestinationHost = NULL;
...
Integer32* AbortSessionRequest::setAuthApplicationId(){
	mMandatoryAvpSetVal [AbortSessionRequest_AUTHAPPLICATIONID] = 1;
	if(mAuthApplicationId == NULL)
	{
		mAuthApplicationId = new Integer32();
		mTagsPresent[AbortSessionRequest_AUTHAPPLICATIONID] = 1;
		return mAuthApplicationId;
	}
	return mAuthApplicationId;
}

void AbortSessionRequest::resetAuthApplicationId(){
	mTagsPresent[AbortSessionRequest_AUTHAPPLICATIONID] = 0;
	if(mAuthApplicationId != NULL)
	{
		delete mAuthApplicationId; 
		mAuthApplicationId = NULL;
...
OctetString* AbortSessionRequest::setUserName(){
	mMandatoryAvpSetVal [AbortSessionRequest_USERNAME] = 1;
	if(mUserName == NULL)
	{
		mUserName = new OctetString();
		mTagsPresent[AbortSessionRequest_USERNAME] = 1;
		return mUserName;
	}
	return mUserName;
}

void AbortSessionRequest::resetUserName(){
	mTagsPresent[AbortSessionRequest_USERNAME] = 0;
	if(mUserName != NULL)
	{
		delete mUserName; 
		mUserName = NULL;
...
CCRequestType* AbortSessionRequest::setCCRequestType(){
	mMandatoryAvpSetVal [AbortSessionRequest_CCREQUESTTYPE] = 1;
	if(mCCRequestType == NULL)
	{
		mCCRequestType = new CCRequestType();
		mTagsPresent[AbortSessionRequest_CCREQUESTTYPE] = 1;
		return mCCRequestType;
	}
	return mCCRequestType;
}

void AbortSessionRequest::resetCCRequestType(){
	mTagsPresent[AbortSessionRequest_CCREQUESTTYPE] = 0;
	if(mCCRequestType != NULL)
	{
		delete mCCRequestType; 
		mCCRequestType = NULL;
...
OctetString* AbortSessionRequest::getSessionId(){
	if(NULL == mSessionId) {
...
OctetString* AbortSessionRequest::getOriginHost(){
	if(NULL == mOriginHost) {
...
OctetString* AbortSessionRequest::getOriginRealm(){
...
Unsigned32* AbortSessionRequest::getOriginStateId(){
...
OctetString* AbortSessionRequest::getDestinationRealm(){
...
OctetString* AbortSessionRequest::getDestinationHost(){
...
Integer32* AbortSessionRequest::getAuthApplicationId(){
...
OctetString* AbortSessionRequest::getUserName(){
	if(NULL == mUserName) {
...
list<ProxyInfo*>* AbortSessionRequest::getProxyInfoGrpList()
{
	if(mProxyInfoGrpList == NULL)
	{
	...
	for(auto itr : *mProxyInfoGrpList)
	{
		...
		{
			mTagsPresent[AbortSessionRequest_PROXYINFO] = 0;
			mProxyInfoGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "ProxyInfo is Null");
			throw lTssDiaMsgException;
		}
...
list<ProxyInfo*>* AbortSessionRequest::setProxyInfoGrpList(){
	mTagsPresent[AbortSessionRequest_PROXYINFO] = 1;
	if(mProxyInfoGrpList == NULL)
		mProxyInfoGrpList = new list<ProxyInfo*>;
	mMandatoryAvpSetVal[AbortSessionRequest_PROXYINFO] = 1;
	mProxyInfoGrpList->clear();
	return mProxyInfoGrpList;
}

void AbortSessionRequest::resetProxyInfoGrpList(){
	mTagsPresent[AbortSessionRequest_PROXYINFO] = 0;
	if(mProxyInfoGrpList != NULL)
		delete mProxyInfoGrpList;
}

list<OctetString*>* AbortSessionRequest::getRouteRecordList()
{
	if(mRouteRecordList == NULL)
	{
...
list<OctetString*>* AbortSessionRequest::setRouteRecordList() {
	mTagsPresent[AbortSessionRequest_ROUTERECORD] = 1;
	if(mRouteRecordList == NULL)
		mRouteRecordList = new list<OctetString*>;
	mMandatoryAvpSetVal [AbortSessionRequest_ROUTERECORD] = 1;
	mRouteRecordList->clear();
	return mRouteRecordList;
}

void AbortSessionRequest::resetRouteRecordList(){
	mTagsPresent[AbortSessionRequest_ROUTERECORD] = 0;
	if(mRouteRecordList != NULL)
		delete mRouteRecordList;
}

CCRequestType* AbortSessionRequest::getCCRequestType(){
...
int AbortSessionRequest::Encode(byteArray *array)
{
	...
	array->byte[array->offset++] = (274>>16) & 0xFF;
	array->byte[array->offset++] = (274>>8) & 0xFF;
	array->byte[array->offset++] = (274) & 0xFF;
	...
	for(unsigned int i = 0 ; i < mTagsPresent.size() ; ++i )
	{
		...
		switch(i)
		{
			case AbortSessionRequest_SESSIONID:
			{
					array->size+=4;
				...
				break;
			case AbortSessionRequest_ORIGINHOST:
			{
					array->size+=4;
				...
				break;
			case AbortSessionRequest_ORIGINREALM:
			{
					array->size+=4;
				...
				break;
			case AbortSessionRequest_ORIGINSTATEID:
			{
					array->size+=4;
				...
				break;
			case AbortSessionRequest_DESTINATIONREALM:
			{
					array->size+=4;
				...
				break;
			case AbortSessionRequest_DESTINATIONHOST:
			{
					array->size+=4;
				...
				break;
			case AbortSessionRequest_AUTHAPPLICATIONID:
			{
					array->size+=4;
				...
				break;
			case AbortSessionRequest_USERNAME:
			{
					array->size+=4;
				...
				break;
			case AbortSessionRequest_PROXYINFO:
			{
				if( mProxyInfoGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case AbortSessionRequest_ROUTERECORD:
			{
				...
				break;
			case AbortSessionRequest_CCREQUESTTYPE:
			{
					array->size+=4;
...
int AbortSessionRequest::Decode(byteArray *array, INT16 lMLen, UINT16 *parsedBytes)
{
...
DiameterBaseInterface* AbortSessionRequest::Find(byteArray *array, UINT32 avpCode)
{
...
BOOLEAN AbortSessionRequest::FindAll(byteArray *array, UINT32 avpCode, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
std::shared_ptr<byteArray> AbortSessionRequest::GetByteArray()
{
	return mspByteArray;
}


BOOLEAN AbortSessionRequest::FindAll(byteArray *array, std::map<int,UINT32> &avpCodeMap, int &size, int key, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
void AbortSessionRequest::Display(UINT32 tab)
{
...
BOOLEAN AbortSessionRequest::GetMissingAvpInfo(TEXT *lMissingAvpInfo)
{
