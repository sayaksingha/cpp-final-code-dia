...
BOOLEAN DisconnectPeerAnswer::isPresent(int tag){
	return (mTagsPresent[tag])?true:false;
}

DisconnectPeerAnswer::DisconnectPeerAnswer()
{
	mSessionId = NULL;
	mResultCode = NULL;
	mOriginHost = NULL;
	...
	mCCRequestType = NULL;
	mTagsPresent.reset();
	mMandatoryAvpCheckVal= bitset<6>(string("101111"));
...
OctetString* DisconnectPeerAnswer::setSessionId(){
	mMandatoryAvpSetVal [DisconnectPeerAnswer_SESSIONID] = 1;
	if(mSessionId == NULL)
	{
		mSessionId = new OctetString();
		mTagsPresent[DisconnectPeerAnswer_SESSIONID] = 1;
		return mSessionId;
	}
	return mSessionId;
}

void DisconnectPeerAnswer::resetSessionId(){
	mTagsPresent[DisconnectPeerAnswer_SESSIONID] = 0;
	if(mSessionId != NULL)
	{
		delete mSessionId; 
		mSessionId = NULL;
...
Unsigned32* DisconnectPeerAnswer::setResultCode(){
	mMandatoryAvpSetVal [DisconnectPeerAnswer_RESULTCODE] = 1;
	if(mResultCode == NULL)
	{
		mResultCode = new Unsigned32();
		mTagsPresent[DisconnectPeerAnswer_RESULTCODE] = 1;
		return mResultCode;
	}
	return mResultCode;
}

void DisconnectPeerAnswer::resetResultCode(){
	mTagsPresent[DisconnectPeerAnswer_RESULTCODE] = 0;
	if(mResultCode != NULL)
	{
		delete mResultCode; 
		mResultCode = NULL;
...
OctetString* DisconnectPeerAnswer::setOriginHost(){
	mMandatoryAvpSetVal [DisconnectPeerAnswer_ORIGINHOST] = 1;
	if(mOriginHost == NULL)
	{
		mOriginHost = new OctetString();
		mTagsPresent[DisconnectPeerAnswer_ORIGINHOST] = 1;
		return mOriginHost;
	}
	return mOriginHost;
}

void DisconnectPeerAnswer::resetOriginHost(){
	mTagsPresent[DisconnectPeerAnswer_ORIGINHOST] = 0;
	if(mOriginHost != NULL)
	{
		delete mOriginHost; 
		mOriginHost = NULL;
...
OctetString* DisconnectPeerAnswer::setOriginRealm(){
	mMandatoryAvpSetVal [DisconnectPeerAnswer_ORIGINREALM] = 1;
	if(mOriginRealm == NULL)
	{
		mOriginRealm = new OctetString();
		mTagsPresent[DisconnectPeerAnswer_ORIGINREALM] = 1;
		return mOriginRealm;
	}
	return mOriginRealm;
}

void DisconnectPeerAnswer::resetOriginRealm(){
	mTagsPresent[DisconnectPeerAnswer_ORIGINREALM] = 0;
	if(mOriginRealm != NULL)
	{
		delete mOriginRealm; 
		mOriginRealm = NULL;
...
OctetString* DisconnectPeerAnswer::setErrorMessage(){
	if(mErrorMessage == NULL)
	{
		mErrorMessage = new OctetString();
		mTagsPresent[DisconnectPeerAnswer_ERRORMESSAGE] = 1;
		return mErrorMessage;
	}
	return mErrorMessage;
}

void DisconnectPeerAnswer::resetErrorMessage(){
	mTagsPresent[DisconnectPeerAnswer_ERRORMESSAGE] = 0;
	if(mErrorMessage != NULL)
	{
		delete mErrorMessage; 
		mErrorMessage = NULL;
...
CCRequestType* DisconnectPeerAnswer::setCCRequestType(){
	mMandatoryAvpSetVal [DisconnectPeerAnswer_CCREQUESTTYPE] = 1;
	if(mCCRequestType == NULL)
	{
		mCCRequestType = new CCRequestType();
		mTagsPresent[DisconnectPeerAnswer_CCREQUESTTYPE] = 1;
		return mCCRequestType;
	}
	return mCCRequestType;
}

void DisconnectPeerAnswer::resetCCRequestType(){
	mTagsPresent[DisconnectPeerAnswer_CCREQUESTTYPE] = 0;
	if(mCCRequestType != NULL)
	{
		delete mCCRequestType; 
		mCCRequestType = NULL;
...
OctetString* DisconnectPeerAnswer::getSessionId(){
	if(NULL == mSessionId) {
...
Unsigned32* DisconnectPeerAnswer::getResultCode(){
	if(NULL == mResultCode) {
...
OctetString* DisconnectPeerAnswer::getOriginHost(){
	if(NULL == mOriginHost) {
...
OctetString* DisconnectPeerAnswer::getOriginRealm(){
...
OctetString* DisconnectPeerAnswer::getErrorMessage(){
...
CCRequestType* DisconnectPeerAnswer::getCCRequestType(){
...
int DisconnectPeerAnswer::Encode(byteArray *array)
{
	...
	for(unsigned int i = 0 ; i < mTagsPresent.size() ; ++i )
	{
		...
		switch(i)
		{
			case DisconnectPeerAnswer_SESSIONID:
			{
					array->size+=4;
				...
				break;
			case DisconnectPeerAnswer_RESULTCODE:
			{
					array->size+=4;
				...
				break;
			case DisconnectPeerAnswer_ORIGINHOST:
			{
					array->size+=4;
				...
				break;
			case DisconnectPeerAnswer_ORIGINREALM:
			{
					array->size+=4;
				...
				break;
			case DisconnectPeerAnswer_ERRORMESSAGE:
			{
					array->size+=4;
				...
				break;
			case DisconnectPeerAnswer_CCREQUESTTYPE:
			{
					array->size+=4;
...
int DisconnectPeerAnswer::Decode(byteArray *array, INT16 lMLen, UINT16 *parsedBytes)
{
...
DiameterBaseInterface* DisconnectPeerAnswer::Find(byteArray *array, UINT32 avpCode)
{
...
BOOLEAN DisconnectPeerAnswer::FindAll(byteArray *array, UINT32 avpCode, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
std::shared_ptr<byteArray> DisconnectPeerAnswer::GetByteArray()
{
	return mspByteArray;
}


BOOLEAN DisconnectPeerAnswer::FindAll(byteArray *array, std::map<int,UINT32> &avpCodeMap, int &size, int key, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
void DisconnectPeerAnswer::Display(UINT32 tab)
{
...
BOOLEAN DisconnectPeerAnswer::GetMissingAvpInfo(TEXT *lMissingAvpInfo)
{
