...
using namespace SD;
BOOLEAN CreditControlAnswer::isPresent(int tag){
...
CreditControlAnswer::CreditControlAnswer()
{
	...
	mLoadGrpList = NULL;
	mTagsPresent.reset();
	mMandatoryAvpCheckVal= bitset<31>(string("0011100011111110011100111111101"));
...
OctetString* CreditControlAnswer::setSessionId(){
	mMandatoryAvpSetVal [CreditControlAnswer_SESSIONID] = 1;
	if(mSessionId == NULL)
	{
		mSessionId = new OctetString();
		mTagsPresent[CreditControlAnswer_SESSIONID] = 1;
		return mSessionId;
	}
	return mSessionId;
}

void CreditControlAnswer::resetSessionId(){
	mTagsPresent[CreditControlAnswer_SESSIONID] = 0;
	if(mSessionId != NULL)
	{
		delete mSessionId; 
		mSessionId = NULL;
...
DRMP* CreditControlAnswer::setDRMP(){
	if(mDRMP == NULL)
	{
		mDRMP = new DRMP();
		mTagsPresent[CreditControlAnswer_DRMP] = 1;
		return mDRMP;
	}
	return mDRMP;
}

void CreditControlAnswer::resetDRMP(){
	mTagsPresent[CreditControlAnswer_DRMP] = 0;
	if(mDRMP != NULL)
	{
		delete mDRMP; 
		mDRMP = NULL;
...
Integer32* CreditControlAnswer::setAuthApplicationId(){
	mMandatoryAvpSetVal [CreditControlAnswer_AUTHAPPLICATIONID] = 1;
	if(mAuthApplicationId == NULL)
	{
		mAuthApplicationId = new Integer32();
		mTagsPresent[CreditControlAnswer_AUTHAPPLICATIONID] = 1;
		return mAuthApplicationId;
	}
	return mAuthApplicationId;
}

void CreditControlAnswer::resetAuthApplicationId(){
	mTagsPresent[CreditControlAnswer_AUTHAPPLICATIONID] = 0;
	if(mAuthApplicationId != NULL)
	{
		delete mAuthApplicationId; 
		mAuthApplicationId = NULL;
...
OctetString* CreditControlAnswer::setOriginHost(){
	mMandatoryAvpSetVal [CreditControlAnswer_ORIGINHOST] = 1;
	if(mOriginHost == NULL)
	{
		mOriginHost = new OctetString();
		mTagsPresent[CreditControlAnswer_ORIGINHOST] = 1;
		return mOriginHost;
	}
	return mOriginHost;
}

void CreditControlAnswer::resetOriginHost(){
	mTagsPresent[CreditControlAnswer_ORIGINHOST] = 0;
	if(mOriginHost != NULL)
	{
		delete mOriginHost; 
		mOriginHost = NULL;
...
OctetString* CreditControlAnswer::setOriginRealm(){
	mMandatoryAvpSetVal [CreditControlAnswer_ORIGINREALM] = 1;
	if(mOriginRealm == NULL)
	{
		mOriginRealm = new OctetString();
		mTagsPresent[CreditControlAnswer_ORIGINREALM] = 1;
		return mOriginRealm;
	}
	return mOriginRealm;
}

void CreditControlAnswer::resetOriginRealm(){
	mTagsPresent[CreditControlAnswer_ORIGINREALM] = 0;
	if(mOriginRealm != NULL)
	{
		delete mOriginRealm; 
		mOriginRealm = NULL;
...
Unsigned32* CreditControlAnswer::setResultCode(){
	mMandatoryAvpSetVal [CreditControlAnswer_RESULTCODE] = 1;
	if(mResultCode == NULL)
	{
		mResultCode = new Unsigned32();
		mTagsPresent[CreditControlAnswer_RESULTCODE] = 1;
		return mResultCode;
	}
	return mResultCode;
}

void CreditControlAnswer::resetResultCode(){
	mTagsPresent[CreditControlAnswer_RESULTCODE] = 0;
	if(mResultCode != NULL)
	{
		delete mResultCode; 
		mResultCode = NULL;
...
CCRequestType* CreditControlAnswer::setCCRequestType(){
	mMandatoryAvpSetVal [CreditControlAnswer_CCREQUESTTYPE] = 1;
	if(mCCRequestType == NULL)
	{
		mCCRequestType = new CCRequestType();
		mTagsPresent[CreditControlAnswer_CCREQUESTTYPE] = 1;
		return mCCRequestType;
	}
	return mCCRequestType;
}

void CreditControlAnswer::resetCCRequestType(){
	mTagsPresent[CreditControlAnswer_CCREQUESTTYPE] = 0;
	if(mCCRequestType != NULL)
	{
		delete mCCRequestType; 
		mCCRequestType = NULL;
...
Unsigned32* CreditControlAnswer::setCCRequestNumber(){
	mMandatoryAvpSetVal [CreditControlAnswer_CCREQUESTNUMBER] = 1;
	if(mCCRequestNumber == NULL)
	{
		mCCRequestNumber = new Unsigned32();
		mTagsPresent[CreditControlAnswer_CCREQUESTNUMBER] = 1;
		return mCCRequestNumber;
	}
	return mCCRequestNumber;
}

void CreditControlAnswer::resetCCRequestNumber(){
	mTagsPresent[CreditControlAnswer_CCREQUESTNUMBER] = 0;
	if(mCCRequestNumber != NULL)
	{
		delete mCCRequestNumber; 
		mCCRequestNumber = NULL;
...
OctetString* CreditControlAnswer::setFramedIPv6Prefix(){
	mMandatoryAvpSetVal [CreditControlAnswer_FRAMEDIPV6PREFIX] = 1;
	if(mFramedIPv6Prefix == NULL)
	{
		mFramedIPv6Prefix = new OctetString();
		mTagsPresent[CreditControlAnswer_FRAMEDIPV6PREFIX] = 1;
		return mFramedIPv6Prefix;
	}
	return mFramedIPv6Prefix;
}

void CreditControlAnswer::resetFramedIPv6Prefix(){
	mTagsPresent[CreditControlAnswer_FRAMEDIPV6PREFIX] = 0;
	if(mFramedIPv6Prefix != NULL)
	{
		delete mFramedIPv6Prefix; 
		mFramedIPv6Prefix = NULL;
...
Unsigned32* CreditControlAnswer::setOriginStateId(){
	mMandatoryAvpSetVal [CreditControlAnswer_ORIGINSTATEID] = 1;
	if(mOriginStateId == NULL)
	{
		mOriginStateId = new Unsigned32();
		mTagsPresent[CreditControlAnswer_ORIGINSTATEID] = 1;
		return mOriginStateId;
	}
	return mOriginStateId;
}

void CreditControlAnswer::resetOriginStateId(){
	mTagsPresent[CreditControlAnswer_ORIGINSTATEID] = 0;
	if(mOriginStateId != NULL)
	{
		delete mOriginStateId; 
		mOriginStateId = NULL;
...
RedirectHostUsage* CreditControlAnswer::setRedirectHostUsage(){
	mMandatoryAvpSetVal [CreditControlAnswer_REDIRECTHOSTUSAGE] = 1;
	if(mRedirectHostUsage == NULL)
	{
		mRedirectHostUsage = new RedirectHostUsage();
		mTagsPresent[CreditControlAnswer_REDIRECTHOSTUSAGE] = 1;
		return mRedirectHostUsage;
	}
	return mRedirectHostUsage;
}

void CreditControlAnswer::resetRedirectHostUsage(){
	mTagsPresent[CreditControlAnswer_REDIRECTHOSTUSAGE] = 0;
	if(mRedirectHostUsage != NULL)
	{
		delete mRedirectHostUsage; 
		mRedirectHostUsage = NULL;
...
Unsigned32* CreditControlAnswer::setRedirectMaxCacheTime(){
	mMandatoryAvpSetVal [CreditControlAnswer_REDIRECTMAXCACHETIME] = 1;
	if(mRedirectMaxCacheTime == NULL)
	{
		mRedirectMaxCacheTime = new Unsigned32();
		mTagsPresent[CreditControlAnswer_REDIRECTMAXCACHETIME] = 1;
		return mRedirectMaxCacheTime;
	}
	return mRedirectMaxCacheTime;
}

void CreditControlAnswer::resetRedirectMaxCacheTime(){
	mTagsPresent[CreditControlAnswer_REDIRECTMAXCACHETIME] = 0;
	if(mRedirectMaxCacheTime != NULL)
	{
		delete mRedirectMaxCacheTime; 
		mRedirectMaxCacheTime = NULL;
...
Time* CreditControlAnswer::setRevalidationTime(){
	mMandatoryAvpSetVal [CreditControlAnswer_REVALIDATIONTIME] = 1;
	if(mRevalidationTime == NULL)
	{
		mRevalidationTime = new Time();
		mTagsPresent[CreditControlAnswer_REVALIDATIONTIME] = 1;
		return mRevalidationTime;
	}
	return mRevalidationTime;
}

void CreditControlAnswer::resetRevalidationTime(){
	mTagsPresent[CreditControlAnswer_REVALIDATIONTIME] = 0;
	if(mRevalidationTime != NULL)
	{
		delete mRevalidationTime; 
		mRevalidationTime = NULL;
...
OctetString* CreditControlAnswer::setErrorMessage(){
	if(mErrorMessage == NULL)
	{
		mErrorMessage = new OctetString();
		mTagsPresent[CreditControlAnswer_ERRORMESSAGE] = 1;
		return mErrorMessage;
	}
	return mErrorMessage;
}

void CreditControlAnswer::resetErrorMessage(){
	mTagsPresent[CreditControlAnswer_ERRORMESSAGE] = 0;
	if(mErrorMessage != NULL)
	{
		delete mErrorMessage; 
		mErrorMessage = NULL;
...
OctetString* CreditControlAnswer::setErrorReportingHost(){
	if(mErrorReportingHost == NULL)
	{
		mErrorReportingHost = new OctetString();
		mTagsPresent[CreditControlAnswer_ERRORREPORTINGHOST] = 1;
		return mErrorReportingHost;
	}
	return mErrorReportingHost;
}

void CreditControlAnswer::resetErrorReportingHost(){
	mTagsPresent[CreditControlAnswer_ERRORREPORTINGHOST] = 0;
	if(mErrorReportingHost != NULL)
	{
		delete mErrorReportingHost; 
		mErrorReportingHost = NULL;
...
OctetString* CreditControlAnswer::getSessionId(){
	if(NULL == mSessionId) {
...
DRMP* CreditControlAnswer::getDRMP(){
	if(NULL == mDRMP) {
...
Integer32* CreditControlAnswer::getAuthApplicationId(){
...
OctetString* CreditControlAnswer::getOriginHost(){
	if(NULL == mOriginHost) {
...
OctetString* CreditControlAnswer::getOriginRealm(){
...
Unsigned32* CreditControlAnswer::getResultCode(){
	if(NULL == mResultCode) {
...
ExperimentalResult* CreditControlAnswer::getExperimentalResult()
{
	if(mExperimentalResultGrp == NULL)
	{
...
ExperimentalResult* CreditControlAnswer::setExperimentalResult(){
	if(mExperimentalResultGrp == NULL)
		mExperimentalResultGrp = new ExperimentalResult();
	mTagsPresent[CreditControlAnswer_EXPERIMENTALRESULT] = 1;
	mMandatoryAvpSetVal[CreditControlAnswer_EXPERIMENTALRESULT] = 1;
	return mExperimentalResultGrp;
}

void CreditControlAnswer::resetExperimentalResult(){
	mTagsPresent[CreditControlAnswer_EXPERIMENTALRESULT] = 0;
	if(mExperimentalResultGrp != NULL)
		delete mExperimentalResultGrp;
}

CCRequestType* CreditControlAnswer::getCCRequestType(){
...
Unsigned32* CreditControlAnswer::getCCRequestNumber(){
...
OCSupportedFeatures* CreditControlAnswer::getOCSupportedFeatures()
{
	if(mOCSupportedFeaturesGrp == NULL)
	{
...
OCSupportedFeatures* CreditControlAnswer::setOCSupportedFeatures(){
	if(mOCSupportedFeaturesGrp == NULL)
		mOCSupportedFeaturesGrp = new OCSupportedFeatures();
	mTagsPresent[CreditControlAnswer_OCSUPPORTEDFEATURES] = 1;
	return mOCSupportedFeaturesGrp;
}

void CreditControlAnswer::resetOCSupportedFeatures(){
	mTagsPresent[CreditControlAnswer_OCSUPPORTEDFEATURES] = 0;
	if(mOCSupportedFeaturesGrp != NULL)
		delete mOCSupportedFeaturesGrp;
}

OCOLR* CreditControlAnswer::getOCOLR()
{
	if(mOCOLRGrp == NULL)
	{
...
OCOLR* CreditControlAnswer::setOCOLR(){
	if(mOCOLRGrp == NULL)
		mOCOLRGrp = new OCOLR();
	mTagsPresent[CreditControlAnswer_OCOLR] = 1;
	return mOCOLRGrp;
}

void CreditControlAnswer::resetOCOLR(){
	mTagsPresent[CreditControlAnswer_OCOLR] = 0;
	if(mOCOLRGrp != NULL)
		delete mOCOLRGrp;
}

OctetString* CreditControlAnswer::getFramedIPv6Prefix(){
...
QoSInformation* CreditControlAnswer::getQoSInformation()
{
	if(mQoSInformationGrp == NULL)
	{
...
QoSInformation* CreditControlAnswer::setQoSInformation(){
	if(mQoSInformationGrp == NULL)
		mQoSInformationGrp = new QoSInformation();
	mTagsPresent[CreditControlAnswer_QOSINFORMATION] = 1;
	mMandatoryAvpSetVal[CreditControlAnswer_QOSINFORMATION] = 1;
	return mQoSInformationGrp;
}

void CreditControlAnswer::resetQoSInformation(){
	mTagsPresent[CreditControlAnswer_QOSINFORMATION] = 0;
	if(mQoSInformationGrp != NULL)
		delete mQoSInformationGrp;
}

list<EventTrigger*>* CreditControlAnswer::getEventTriggerList()
{
	if(mEventTriggerList == NULL)
	{
...
list<EventTrigger*>* CreditControlAnswer::setEventTriggerList() {
	mTagsPresent[CreditControlAnswer_EVENTTRIGGER] = 1;
	if(mEventTriggerList == NULL)
		mEventTriggerList = new list<EventTrigger*>;
	mMandatoryAvpSetVal [CreditControlAnswer_EVENTTRIGGER] = 1;
	mEventTriggerList->clear();
	return mEventTriggerList;
}

void CreditControlAnswer::resetEventTriggerList(){
	mTagsPresent[CreditControlAnswer_EVENTTRIGGER] = 0;
	if(mEventTriggerList != NULL)
		delete mEventTriggerList;
}

list<CSGInformationReporting*>* CreditControlAnswer::getCSGInformationReportingList()
{
	if(mCSGInformationReportingList == NULL)
	{
...
list<CSGInformationReporting*>* CreditControlAnswer::setCSGInformationReportingList() {
	mTagsPresent[CreditControlAnswer_CSGINFORMATIONREPORTING] = 1;
	if(mCSGInformationReportingList == NULL)
...
void CreditControlAnswer::resetCSGInformationReportingList(){
	mTagsPresent[CreditControlAnswer_CSGINFORMATIONREPORTING] = 0;
	if(mCSGInformationReportingList != NULL)
		delete mCSGInformationReportingList;
}

EventReportIndication* CreditControlAnswer::getEventReportIndication()
{
	if(mEventReportIndicationGrp == NULL)
	{
...
EventReportIndication* CreditControlAnswer::setEventReportIndication(){
	if(mEventReportIndicationGrp == NULL)
		mEventReportIndicationGrp = new EventReportIndication();
	mTagsPresent[CreditControlAnswer_EVENTREPORTINDICATION] = 1;
	return mEventReportIndicationGrp;
}

void CreditControlAnswer::resetEventReportIndication(){
	mTagsPresent[CreditControlAnswer_EVENTREPORTINDICATION] = 0;
	if(mEventReportIndicationGrp != NULL)
		delete mEventReportIndicationGrp;
}

Unsigned32* CreditControlAnswer::getOriginStateId(){
...
list<OctetString*>* CreditControlAnswer::getRedirectHostList()
{
	if(mRedirectHostList == NULL)
	{
...
list<OctetString*>* CreditControlAnswer::setRedirectHostList() {
	mTagsPresent[CreditControlAnswer_REDIRECTHOST] = 1;
	if(mRedirectHostList == NULL)
		mRedirectHostList = new list<OctetString*>;
	mMandatoryAvpSetVal [CreditControlAnswer_REDIRECTHOST] = 1;
	mRedirectHostList->clear();
	return mRedirectHostList;
}

void CreditControlAnswer::resetRedirectHostList(){
	mTagsPresent[CreditControlAnswer_REDIRECTHOST] = 0;
	if(mRedirectHostList != NULL)
		delete mRedirectHostList;
}

RedirectHostUsage* CreditControlAnswer::getRedirectHostUsage(){
...
Unsigned32* CreditControlAnswer::getRedirectMaxCacheTime(){
...
list<ADCRuleRemove*>* CreditControlAnswer::getADCRuleRemoveGrpList()
{
	if(mADCRuleRemoveGrpList == NULL)
	{
	...
	for(auto itr : *mADCRuleRemoveGrpList)
	{
		...
		{
			mTagsPresent[CreditControlAnswer_ADCRULEREMOVE] = 0;
			mADCRuleRemoveGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "ADCRuleRemove is Null");
			throw lTssDiaMsgException;
		}
...
list<ADCRuleRemove*>* CreditControlAnswer::setADCRuleRemoveGrpList(){
	mTagsPresent[CreditControlAnswer_ADCRULEREMOVE] = 1;
	if(mADCRuleRemoveGrpList == NULL)
		mADCRuleRemoveGrpList = new list<ADCRuleRemove*>;
	mMandatoryAvpSetVal[CreditControlAnswer_ADCRULEREMOVE] = 1;
	mADCRuleRemoveGrpList->clear();
	return mADCRuleRemoveGrpList;
}

void CreditControlAnswer::resetADCRuleRemoveGrpList(){
	mTagsPresent[CreditControlAnswer_ADCRULEREMOVE] = 0;
	if(mADCRuleRemoveGrpList != NULL)
		delete mADCRuleRemoveGrpList;
}

list<ADCRuleInstall*>* CreditControlAnswer::getADCRuleInstallGrpList()
{
	if(mADCRuleInstallGrpList == NULL)
	{
	...
	for(auto itr : *mADCRuleInstallGrpList)
	{
		...
		{
			mTagsPresent[CreditControlAnswer_ADCRULEINSTALL] = 0;
			mADCRuleInstallGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "ADCRuleInstall is Null");
			throw lTssDiaMsgException;
		}
...
list<ADCRuleInstall*>* CreditControlAnswer::setADCRuleInstallGrpList(){
	mTagsPresent[CreditControlAnswer_ADCRULEINSTALL] = 1;
	if(mADCRuleInstallGrpList == NULL)
		mADCRuleInstallGrpList = new list<ADCRuleInstall*>;
	mMandatoryAvpSetVal[CreditControlAnswer_ADCRULEINSTALL] = 1;
	mADCRuleInstallGrpList->clear();
	return mADCRuleInstallGrpList;
}

void CreditControlAnswer::resetADCRuleInstallGrpList(){
	mTagsPresent[CreditControlAnswer_ADCRULEINSTALL] = 0;
	if(mADCRuleInstallGrpList != NULL)
		delete mADCRuleInstallGrpList;
}

Time* CreditControlAnswer::getRevalidationTime(){
...
list<UsageMonitoringInformation*>* CreditControlAnswer::getUsageMonitoringInformationGrpList()
{
	if(mUsageMonitoringInformationGrpList == NULL)
	{
	...
	for(auto itr : *mUsageMonitoringInformationGrpList)
	{
		...
		{
			mTagsPresent[CreditControlAnswer_USAGEMONITORINGINFORMATION] = 0;
			mUsageMonitoringInformationGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "UsageMonitoringInformation is Null");
			throw lTssDiaMsgException;
		}
...
list<UsageMonitoringInformation*>* CreditControlAnswer::setUsageMonitoringInformationGrpList(){
	mTagsPresent[CreditControlAnswer_USAGEMONITORINGINFORMATION] = 1;
	if(mUsageMonitoringInformationGrpList == NULL)
...
void CreditControlAnswer::resetUsageMonitoringInformationGrpList(){
	mTagsPresent[CreditControlAnswer_USAGEMONITORINGINFORMATION] = 0;
	if(mUsageMonitoringInformationGrpList != NULL)
		delete mUsageMonitoringInformationGrpList;
}

OctetString* CreditControlAnswer::getErrorMessage(){
...
OctetString* CreditControlAnswer::getErrorReportingHost(){
...
FailedAVP* CreditControlAnswer::getFailedAVP()
{
	if(mFailedAVPGrp == NULL)
	{
...
FailedAVP* CreditControlAnswer::setFailedAVP(){
	if(mFailedAVPGrp == NULL)
		mFailedAVPGrp = new FailedAVP();
	mTagsPresent[CreditControlAnswer_FAILEDAVP] = 1;
	mMandatoryAvpSetVal[CreditControlAnswer_FAILEDAVP] = 1;
	return mFailedAVPGrp;
}

void CreditControlAnswer::resetFailedAVP(){
	mTagsPresent[CreditControlAnswer_FAILEDAVP] = 0;
	if(mFailedAVPGrp != NULL)
		delete mFailedAVPGrp;
}

list<SD::ProxyInfo*>* CreditControlAnswer::getProxyInfoGrpList()
{
	if(mProxyInfoGrpList == NULL)
	{
	...
	for(auto itr : *mProxyInfoGrpList)
	{
		...
		{
			mTagsPresent[CreditControlAnswer_PROXYINFO] = 0;
			mProxyInfoGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "ProxyInfo is Null");
			throw lTssDiaMsgException;
		}
...
list<SD::ProxyInfo*>* CreditControlAnswer::setProxyInfoGrpList(){
	mTagsPresent[CreditControlAnswer_PROXYINFO] = 1;
	if(mProxyInfoGrpList == NULL)
		mProxyInfoGrpList = new list<SD::ProxyInfo*>;
	mMandatoryAvpSetVal[CreditControlAnswer_PROXYINFO] = 1;
	mProxyInfoGrpList->clear();
	return mProxyInfoGrpList;
}

void CreditControlAnswer::resetProxyInfoGrpList(){
	mTagsPresent[CreditControlAnswer_PROXYINFO] = 0;
	if(mProxyInfoGrpList != NULL)
		delete mProxyInfoGrpList;
}

list<OctetString*>* CreditControlAnswer::getRouteRecordList()
{
	if(mRouteRecordList == NULL)
	{
...
list<OctetString*>* CreditControlAnswer::setRouteRecordList() {
	mTagsPresent[CreditControlAnswer_ROUTERECORD] = 1;
	if(mRouteRecordList == NULL)
		mRouteRecordList = new list<OctetString*>;
	mMandatoryAvpSetVal [CreditControlAnswer_ROUTERECORD] = 1;
	mRouteRecordList->clear();
	return mRouteRecordList;
}

void CreditControlAnswer::resetRouteRecordList(){
	mTagsPresent[CreditControlAnswer_ROUTERECORD] = 0;
	if(mRouteRecordList != NULL)
		delete mRouteRecordList;
}

list<SupportedFeatures*>* CreditControlAnswer::getSupportedFeaturesGrpList()
{
	if(mSupportedFeaturesGrpList == NULL)
	{
	...
	for(auto itr : *mSupportedFeaturesGrpList)
	{
		...
		{
			mTagsPresent[CreditControlAnswer_SUPPORTEDFEATURES] = 0;
			mSupportedFeaturesGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "SupportedFeatures is Null");
			throw lTssDiaMsgException;
		}
...
list<SupportedFeatures*>* CreditControlAnswer::setSupportedFeaturesGrpList(){
	mTagsPresent[CreditControlAnswer_SUPPORTEDFEATURES] = 1;
	if(mSupportedFeaturesGrpList == NULL)
...
void CreditControlAnswer::resetSupportedFeaturesGrpList(){
	mTagsPresent[CreditControlAnswer_SUPPORTEDFEATURES] = 0;
	if(mSupportedFeaturesGrpList != NULL)
		delete mSupportedFeaturesGrpList;
}

list<Load*>* CreditControlAnswer::getLoadGrpList()
{
	if(mLoadGrpList == NULL)
	{
	...
	for(auto itr : *mLoadGrpList)
	{
		...
		{
			mTagsPresent[CreditControlAnswer_LOAD] = 0;
			mLoadGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "Load is Null");
			throw lTssDiaMsgException;
		}
...
list<Load*>* CreditControlAnswer::setLoadGrpList(){
	mTagsPresent[CreditControlAnswer_LOAD] = 1;
	if(mLoadGrpList == NULL)
...
void CreditControlAnswer::resetLoadGrpList(){
	mTagsPresent[CreditControlAnswer_LOAD] = 0;
	if(mLoadGrpList != NULL)
		delete mLoadGrpList;
}
...
int CreditControlAnswer::Encode(byteArray *array)
{
	...
	for(unsigned int i = 0 ; i < mTagsPresent.size() ; ++i )
	{
		...
		switch(i)
		{
			case CreditControlAnswer_SESSIONID:
			{
					array->size+=4;
			...
			case CreditControlAnswer_DRMP:
			{
				...
				break;
			case CreditControlAnswer_AUTHAPPLICATIONID:
			{
					array->size+=4;
				...
				break;
			case CreditControlAnswer_ORIGINHOST:
			{
					array->size+=4;
				...
				break;
			case CreditControlAnswer_ORIGINREALM:
			{
					array->size+=4;
				...
				break;
			case CreditControlAnswer_RESULTCODE:
			{
					array->size+=4;
				...
				break;
			case CreditControlAnswer_EXPERIMENTALRESULT:
			{
				array->size+=4;
				...
				break;
			case CreditControlAnswer_CCREQUESTTYPE:
			{
					array->size+=4;
				...
				break;
			case CreditControlAnswer_CCREQUESTNUMBER:
			{
					array->size+=4;
				...
				break;
			case CreditControlAnswer_OCSUPPORTEDFEATURES:
			{
				array->size+=4;
				...
				break;
			case CreditControlAnswer_OCOLR:
			{
				array->size+=4;
				...
				break;
			case CreditControlAnswer_FRAMEDIPV6PREFIX:
			{
					array->size+=4;
				...
				break;
			case CreditControlAnswer_QOSINFORMATION:
			{
				array->size+=4;
				...
				break;
			case CreditControlAnswer_EVENTTRIGGER:
			{
				...
				break;
			case CreditControlAnswer_CSGINFORMATIONREPORTING:
			{
				...
				break;
			case CreditControlAnswer_EVENTREPORTINDICATION:
			{
				array->size+=4;
				...
				break;
			case CreditControlAnswer_ORIGINSTATEID:
			{
					array->size+=4;
				...
				break;
			case CreditControlAnswer_REDIRECTHOST:
			{
				...
				break;
			case CreditControlAnswer_REDIRECTHOSTUSAGE:
			{
					array->size+=4;
				...
				break;
			case CreditControlAnswer_REDIRECTMAXCACHETIME:
			{
					array->size+=4;
				...
				break;
			case CreditControlAnswer_ADCRULEREMOVE:
			{
				if( mADCRuleRemoveGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case CreditControlAnswer_ADCRULEINSTALL:
			{
				if( mADCRuleInstallGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case CreditControlAnswer_REVALIDATIONTIME:
			{
					array->size+=4;
				...
				break;
			case CreditControlAnswer_USAGEMONITORINGINFORMATION:
			{
				if( mUsageMonitoringInformationGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case CreditControlAnswer_ERRORMESSAGE:
			{
					array->size+=4;
				...
				break;
			case CreditControlAnswer_ERRORREPORTINGHOST:
			{
					array->size+=4;
				...
				break;
			case CreditControlAnswer_FAILEDAVP:
			{
				array->size+=4;
				...
				break;
			case CreditControlAnswer_PROXYINFO:
			{
				if( mProxyInfoGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case CreditControlAnswer_ROUTERECORD:
			{
				...
				break;
			case CreditControlAnswer_SUPPORTEDFEATURES:
			{
				if( mSupportedFeaturesGrpList->size() <= 0) {
					break;
				}
...
int CreditControlAnswer::Decode(byteArray *array, INT16 lMLen, UINT16 *parsedBytes)
{
...
DiameterBaseInterface* CreditControlAnswer::Find(byteArray *array, UINT32 avpCode)
{
...
BOOLEAN CreditControlAnswer::FindAll(byteArray *array, UINT32 avpCode, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
std::shared_ptr<byteArray> CreditControlAnswer::GetByteArray()
{
	return mspByteArray;
}


BOOLEAN CreditControlAnswer::FindAll(byteArray *array, std::map<int,UINT32> &avpCodeMap, int &size, int key, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
void CreditControlAnswer::Display(UINT32 tab)
{
...
BOOLEAN CreditControlAnswer::GetMissingAvpInfo(TEXT *lMissingAvpInfo)
{
