...
using namespace RX;
BOOLEAN RAAnswer::isPresent(int tag){
...
RAAnswer::RAAnswer()
{
	...
	mTagsPresent.reset();
	mMandatoryAvpCheckVal= bitset<19>(string("1111110111100111101"));
...
OctetString* RAAnswer::setSessionId(){
	mMandatoryAvpSetVal [RAAnswer_SESSIONID] = 1;
	if(mSessionId == NULL)
	{
		mSessionId = new OctetString();
		mTagsPresent[RAAnswer_SESSIONID] = 1;
		return mSessionId;
	}
	return mSessionId;
}

void RAAnswer::resetSessionId(){
	mTagsPresent[RAAnswer_SESSIONID] = 0;
	if(mSessionId != NULL)
	{
		delete mSessionId; 
		mSessionId = NULL;
...
DRMP* RAAnswer::setDRMP(){
	if(mDRMP == NULL)
	{
		mDRMP = new DRMP();
		mTagsPresent[RAAnswer_DRMP] = 1;
		return mDRMP;
	}
	return mDRMP;
}

void RAAnswer::resetDRMP(){
	mTagsPresent[RAAnswer_DRMP] = 0;
	if(mDRMP != NULL)
	{
		delete mDRMP; 
		mDRMP = NULL;
...
OctetString* RAAnswer::setOriginHost(){
	mMandatoryAvpSetVal [RAAnswer_ORIGINHOST] = 1;
	if(mOriginHost == NULL)
	{
		mOriginHost = new OctetString();
		mTagsPresent[RAAnswer_ORIGINHOST] = 1;
		return mOriginHost;
	}
	return mOriginHost;
}

void RAAnswer::resetOriginHost(){
	mTagsPresent[RAAnswer_ORIGINHOST] = 0;
	if(mOriginHost != NULL)
	{
		delete mOriginHost; 
		mOriginHost = NULL;
...
OctetString* RAAnswer::setOriginRealm(){
	mMandatoryAvpSetVal [RAAnswer_ORIGINREALM] = 1;
	if(mOriginRealm == NULL)
	{
		mOriginRealm = new OctetString();
		mTagsPresent[RAAnswer_ORIGINREALM] = 1;
		return mOriginRealm;
	}
	return mOriginRealm;
}

void RAAnswer::resetOriginRealm(){
	mTagsPresent[RAAnswer_ORIGINREALM] = 0;
	if(mOriginRealm != NULL)
	{
		delete mOriginRealm; 
		mOriginRealm = NULL;
...
Unsigned32* RAAnswer::setResultCode(){
	mMandatoryAvpSetVal [RAAnswer_RESULTCODE] = 1;
	if(mResultCode == NULL)
	{
		mResultCode = new Unsigned32();
		mTagsPresent[RAAnswer_RESULTCODE] = 1;
		return mResultCode;
	}
	return mResultCode;
}

void RAAnswer::resetResultCode(){
	mTagsPresent[RAAnswer_RESULTCODE] = 0;
	if(mResultCode != NULL)
	{
		delete mResultCode; 
		mResultCode = NULL;
...
OctetString* RAAnswer::setServiceURN(){
	mMandatoryAvpSetVal [RAAnswer_SERVICEURN] = 1;
	if(mServiceURN == NULL)
	{
		mServiceURN = new OctetString();
		mTagsPresent[RAAnswer_SERVICEURN] = 1;
		return mServiceURN;
	}
	return mServiceURN;
}

void RAAnswer::resetServiceURN(){
	mTagsPresent[RAAnswer_SERVICEURN] = 0;
	if(mServiceURN != NULL)
	{
		delete mServiceURN; 
		mServiceURN = NULL;
...
Unsigned32* RAAnswer::setOriginStateId(){
	mMandatoryAvpSetVal [RAAnswer_ORIGINSTATEID] = 1;
	if(mOriginStateId == NULL)
	{
		mOriginStateId = new Unsigned32();
		mTagsPresent[RAAnswer_ORIGINSTATEID] = 1;
		return mOriginStateId;
	}
	return mOriginStateId;
}

void RAAnswer::resetOriginStateId(){
	mTagsPresent[RAAnswer_ORIGINSTATEID] = 0;
	if(mOriginStateId != NULL)
	{
		delete mOriginStateId; 
		mOriginStateId = NULL;
...
OctetString* RAAnswer::setClass(){
	mMandatoryAvpSetVal [RAAnswer_CLASS] = 1;
	if(mClass == NULL)
	{
		mClass = new OctetString();
		mTagsPresent[RAAnswer_CLASS] = 1;
		return mClass;
	}
	return mClass;
}

void RAAnswer::resetClass(){
	mTagsPresent[RAAnswer_CLASS] = 0;
	if(mClass != NULL)
	{
		delete mClass; 
		mClass = NULL;
...
OctetString* RAAnswer::setErrorMessage(){
	if(mErrorMessage == NULL)
	{
		mErrorMessage = new OctetString();
		mTagsPresent[RAAnswer_ERRORMESSAGE] = 1;
		return mErrorMessage;
	}
	return mErrorMessage;
}

void RAAnswer::resetErrorMessage(){
	mTagsPresent[RAAnswer_ERRORMESSAGE] = 0;
	if(mErrorMessage != NULL)
	{
		delete mErrorMessage; 
		mErrorMessage = NULL;
...
OctetString* RAAnswer::setErrorReportingHost(){
	mMandatoryAvpSetVal [RAAnswer_ERRORREPORTINGHOST] = 1;
	if(mErrorReportingHost == NULL)
	{
		mErrorReportingHost = new OctetString();
		mTagsPresent[RAAnswer_ERRORREPORTINGHOST] = 1;
		return mErrorReportingHost;
	}
	return mErrorReportingHost;
}

void RAAnswer::resetErrorReportingHost(){
	mTagsPresent[RAAnswer_ERRORREPORTINGHOST] = 0;
	if(mErrorReportingHost != NULL)
	{
		delete mErrorReportingHost; 
		mErrorReportingHost = NULL;
...
RedirectHostUsage* RAAnswer::setRedirectHostUsage(){
	mMandatoryAvpSetVal [RAAnswer_REDIRECTHOSTUSAGE] = 1;
	if(mRedirectHostUsage == NULL)
	{
		mRedirectHostUsage = new RedirectHostUsage();
		mTagsPresent[RAAnswer_REDIRECTHOSTUSAGE] = 1;
		return mRedirectHostUsage;
	}
	return mRedirectHostUsage;
}

void RAAnswer::resetRedirectHostUsage(){
	mTagsPresent[RAAnswer_REDIRECTHOSTUSAGE] = 0;
	if(mRedirectHostUsage != NULL)
	{
		delete mRedirectHostUsage; 
		mRedirectHostUsage = NULL;
...
Unsigned32* RAAnswer::setRedirectMaxCacheTime(){
	mMandatoryAvpSetVal [RAAnswer_REDIRECTMAXCACHETIME] = 1;
	if(mRedirectMaxCacheTime == NULL)
	{
		mRedirectMaxCacheTime = new Unsigned32();
		mTagsPresent[RAAnswer_REDIRECTMAXCACHETIME] = 1;
		return mRedirectMaxCacheTime;
	}
	return mRedirectMaxCacheTime;
}

void RAAnswer::resetRedirectMaxCacheTime(){
	mTagsPresent[RAAnswer_REDIRECTMAXCACHETIME] = 0;
	if(mRedirectMaxCacheTime != NULL)
	{
		delete mRedirectMaxCacheTime; 
		mRedirectMaxCacheTime = NULL;
...
OctetString* RAAnswer::getSessionId(){
	if(NULL == mSessionId) {
...
OctetString* RAAnswer::getOriginHost(){
	if(NULL == mOriginHost) {
...
OctetString* RAAnswer::getOriginRealm(){
...
Unsigned32* RAAnswer::getResultCode(){
	if(NULL == mResultCode) {
...
ExperimentalResult* RAAnswer::getExperimentalResult()
{
	if(mExperimentalResultGrp == NULL)
	{
...
ExperimentalResult* RAAnswer::setExperimentalResult(){
	if(mExperimentalResultGrp == NULL)
		mExperimentalResultGrp = new ExperimentalResult();
	mTagsPresent[RAAnswer_EXPERIMENTALRESULT] = 1;
	mMandatoryAvpSetVal[RAAnswer_EXPERIMENTALRESULT] = 1;
	return mExperimentalResultGrp;
}

void RAAnswer::resetExperimentalResult(){
	mTagsPresent[RAAnswer_EXPERIMENTALRESULT] = 0;
	if(mExperimentalResultGrp != NULL)
		delete mExperimentalResultGrp;
}

OCSupportedFeatures* RAAnswer::getOCSupportedFeatures()
{
	if(mOCSupportedFeaturesGrp == NULL)
	{
...
OCSupportedFeatures* RAAnswer::setOCSupportedFeatures(){
	if(mOCSupportedFeaturesGrp == NULL)
		mOCSupportedFeaturesGrp = new OCSupportedFeatures();
	mTagsPresent[RAAnswer_OCSUPPORTEDFEATURES] = 1;
	return mOCSupportedFeaturesGrp;
}

void RAAnswer::resetOCSupportedFeatures(){
	mTagsPresent[RAAnswer_OCSUPPORTEDFEATURES] = 0;
	if(mOCSupportedFeaturesGrp != NULL)
		delete mOCSupportedFeaturesGrp;
}

OCOLR* RAAnswer::getOCOLR()
{
	if(mOCOLRGrp == NULL)
	{
...
OCOLR* RAAnswer::setOCOLR(){
	if(mOCOLRGrp == NULL)
		mOCOLRGrp = new OCOLR();
	mTagsPresent[RAAnswer_OCOLR] = 1;
	return mOCOLRGrp;
}

void RAAnswer::resetOCOLR(){
	mTagsPresent[RAAnswer_OCOLR] = 0;
	if(mOCOLRGrp != NULL)
		delete mOCOLRGrp;
}

list<MediaComponentDescription*>* RAAnswer::getMediaComponentDescriptionGrpList()
{
	if(mMediaComponentDescriptionGrpList == NULL)
	{
	...
	for(auto itr : *mMediaComponentDescriptionGrpList)
	{
		...
		{
			mTagsPresent[RAAnswer_MEDIACOMPONENTDESCRIPTION] = 0;
			mMediaComponentDescriptionGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "MediaComponentDescription is Null");
			throw lTssDiaMsgException;
		}
...
list<MediaComponentDescription*>* RAAnswer::setMediaComponentDescriptionGrpList(){
	mTagsPresent[RAAnswer_MEDIACOMPONENTDESCRIPTION] = 1;
	if(mMediaComponentDescriptionGrpList == NULL)
		mMediaComponentDescriptionGrpList = new list<MediaComponentDescription*>;
	mMandatoryAvpSetVal[RAAnswer_MEDIACOMPONENTDESCRIPTION] = 1;
	mMediaComponentDescriptionGrpList->clear();
	return mMediaComponentDescriptionGrpList;
}

void RAAnswer::resetMediaComponentDescriptionGrpList(){
	mTagsPresent[RAAnswer_MEDIACOMPONENTDESCRIPTION] = 0;
	if(mMediaComponentDescriptionGrpList != NULL)
		delete mMediaComponentDescriptionGrpList;
}

OctetString* RAAnswer::getServiceURN(){
	if(NULL == mServiceURN) {
...
Unsigned32* RAAnswer::getOriginStateId(){
...
OctetString* RAAnswer::getErrorMessage(){
...
OctetString* RAAnswer::getErrorReportingHost(){
...
list<OctetString*>* RAAnswer::getRedirectHostList()
{
	if(mRedirectHostList == NULL)
	{
...
list<OctetString*>* RAAnswer::setRedirectHostList() {
	mTagsPresent[RAAnswer_REDIRECTHOST] = 1;
	if(mRedirectHostList == NULL)
		mRedirectHostList = new list<OctetString*>;
	mMandatoryAvpSetVal [RAAnswer_REDIRECTHOST] = 1;
	mRedirectHostList->clear();
	return mRedirectHostList;
}

void RAAnswer::resetRedirectHostList(){
	mTagsPresent[RAAnswer_REDIRECTHOST] = 0;
	if(mRedirectHostList != NULL)
		delete mRedirectHostList;
}

RedirectHostUsage* RAAnswer::getRedirectHostUsage(){
...
Unsigned32* RAAnswer::getRedirectMaxCacheTime(){
...
list<FailedAVP*>* RAAnswer::getFailedAVPGrpList()
{
	if(mFailedAVPGrpList == NULL)
	{
	...
	for(auto itr : *mFailedAVPGrpList)
	{
		...
		{
			mTagsPresent[RAAnswer_FAILEDAVP] = 0;
			mFailedAVPGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "FailedAVP is Null");
			throw lTssDiaMsgException;
		}
...
list<FailedAVP*>* RAAnswer::setFailedAVPGrpList(){
	mTagsPresent[RAAnswer_FAILEDAVP] = 1;
	if(mFailedAVPGrpList == NULL)
		mFailedAVPGrpList = new list<FailedAVP*>;
	mMandatoryAvpSetVal[RAAnswer_FAILEDAVP] = 1;
	mFailedAVPGrpList->clear();
	return mFailedAVPGrpList;
}

void RAAnswer::resetFailedAVPGrpList(){
	mTagsPresent[RAAnswer_FAILEDAVP] = 0;
	if(mFailedAVPGrpList != NULL)
		delete mFailedAVPGrpList;
}

list<RX::ProxyInfo*>* RAAnswer::getProxyInfoGrpList()
{
	if(mProxyInfoGrpList == NULL)
	{
	...
	for(auto itr : *mProxyInfoGrpList)
	{
		...
		{
			mTagsPresent[RAAnswer_PROXYINFO] = 0;
			mProxyInfoGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "ProxyInfo is Null");
			throw lTssDiaMsgException;
		}
...
list<RX::ProxyInfo*>* RAAnswer::setProxyInfoGrpList(){
	mTagsPresent[RAAnswer_PROXYINFO] = 1;
	if(mProxyInfoGrpList == NULL)
		mProxyInfoGrpList = new list<RX::ProxyInfo*>;
	mMandatoryAvpSetVal[RAAnswer_PROXYINFO] = 1;
	mProxyInfoGrpList->clear();
	return mProxyInfoGrpList;
}

void RAAnswer::resetProxyInfoGrpList(){
	mTagsPresent[RAAnswer_PROXYINFO] = 0;
	if(mProxyInfoGrpList != NULL)
		delete mProxyInfoGrpList;
}
...
int RAAnswer::Encode(byteArray *array)
{
	...
	for(unsigned int i = 0 ; i < mTagsPresent.size() ; ++i )
	{
		...
		switch(i)
		{
			...
			case RAAnswer_RESULTCODE:
			{
				...
				break;
			case RAAnswer_EXPERIMENTALRESULT:
			{
				array->size+=4;
				...
				break;
			case RAAnswer_OCSUPPORTEDFEATURES:
			{
				array->size+=4;
			...
			case RAAnswer_OCOLR:
			{
				...
				break;
			case RAAnswer_MEDIACOMPONENTDESCRIPTION:
			{
				if( mMediaComponentDescriptionGrpList->size() <= 0) {
					break;
				}
			...
			case RAAnswer_ERRORMESSAGE:
			{
				...
				break;
			case RAAnswer_ERRORREPORTINGHOST:
			{
					array->size+=4;
			...
			case RAAnswer_REDIRECTHOST:
			{
				...
				break;
			case RAAnswer_REDIRECTHOSTUSAGE:
			{
					array->size+=4;
				...
				break;
			case RAAnswer_REDIRECTMAXCACHETIME:
			{
					array->size+=4;
...
int RAAnswer::Decode(byteArray *array, INT16 lMLen, UINT16 *parsedBytes)
{
...
DiameterBaseInterface* RAAnswer::Find(byteArray *array, UINT32 avpCode)
{
...
BOOLEAN RAAnswer::FindAll(byteArray *array, UINT32 avpCode, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
std::shared_ptr<byteArray> RAAnswer::GetByteArray()
{
	return mspByteArray;
}


BOOLEAN RAAnswer::FindAll(byteArray *array, std::map<int,UINT32> &avpCodeMap, int &size, int key, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
void RAAnswer::Display(UINT32 tab)
{
...
BOOLEAN RAAnswer::GetMissingAvpInfo(TEXT *lMissingAvpInfo)
{
