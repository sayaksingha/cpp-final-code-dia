#ifndef RX_EXPERIMENTALRESULT_H
#define RX_EXPERIMENTALRESULT_H
...
class ExperimentalResult : public DiameterBaseInterface
{
	...
	public:
		...
		mVendorID = new Unsigned32(*(objExperimentalResult.mVendorID));
		...
		/*!		Function to set the recent Unsigned32 type of argument VendorID for datatype ExperimentalResult
		*/
		...
		*/
		...
		/*!		Function to get Unsigned32 type of argument VendorID for datatype ExperimentalResult
