...
using namespace SLH;
BOOLEAN ServingNode::isPresent(int tag){
...
OctetString* ServingNode::setSGSNNumber(){
	mMandatoryAvpSetVal [ServingNode_SGSNNUMBER] = 1;
	if(mSGSNNumber == NULL)
	{
		mSGSNNumber = new OctetString();
		mTagsPresent[ServingNode_SGSNNUMBER] = 1;
		return mSGSNNumber;
	}
	return mSGSNNumber;
}

void ServingNode::resetSGSNNumber(){
	mTagsPresent[ServingNode_SGSNNUMBER] = 0;
	if(mSGSNNumber != NULL)
	{
		delete mSGSNNumber; 
		mSGSNNumber = NULL;
...
OctetString* ServingNode::setSGSNName(){
	if(mSGSNName == NULL)
	{
		mSGSNName = new OctetString();
		mTagsPresent[ServingNode_SGSNNAME] = 1;
		return mSGSNName;
	}
	return mSGSNName;
}

void ServingNode::resetSGSNName(){
	mTagsPresent[ServingNode_SGSNNAME] = 0;
	if(mSGSNName != NULL)
	{
		delete mSGSNName; 
		mSGSNName = NULL;
...
OctetString* ServingNode::setSGSNRealm(){
	if(mSGSNRealm == NULL)
	{
		mSGSNRealm = new OctetString();
		mTagsPresent[ServingNode_SGSNREALM] = 1;
		return mSGSNRealm;
	}
	return mSGSNRealm;
}

void ServingNode::resetSGSNRealm(){
	mTagsPresent[ServingNode_SGSNREALM] = 0;
	if(mSGSNRealm != NULL)
	{
		delete mSGSNRealm; 
		mSGSNRealm = NULL;
...
OctetString* ServingNode::setMMEName(){
	mMandatoryAvpSetVal [ServingNode_MMENAME] = 1;
	if(mMMEName == NULL)
	{
		mMMEName = new OctetString();
		mTagsPresent[ServingNode_MMENAME] = 1;
		return mMMEName;
	}
	return mMMEName;
}

void ServingNode::resetMMEName(){
	mTagsPresent[ServingNode_MMENAME] = 0;
	if(mMMEName != NULL)
	{
		delete mMMEName; 
		mMMEName = NULL;
...
OctetString* ServingNode::setMMERealm(){
	if(mMMERealm == NULL)
	{
		mMMERealm = new OctetString();
		mTagsPresent[ServingNode_MMEREALM] = 1;
		return mMMERealm;
	}
	return mMMERealm;
}

void ServingNode::resetMMERealm(){
	mTagsPresent[ServingNode_MMEREALM] = 0;
	if(mMMERealm != NULL)
	{
		delete mMMERealm; 
		mMMERealm = NULL;
...
OctetString* ServingNode::setMSCNumber(){
	mMandatoryAvpSetVal [ServingNode_MSCNUMBER] = 1;
	if(mMSCNumber == NULL)
	{
		mMSCNumber = new OctetString();
		mTagsPresent[ServingNode_MSCNUMBER] = 1;
		return mMSCNumber;
	}
	return mMSCNumber;
}

void ServingNode::resetMSCNumber(){
	mTagsPresent[ServingNode_MSCNUMBER] = 0;
	if(mMSCNumber != NULL)
	{
		delete mMSCNumber; 
		mMSCNumber = NULL;
...
OctetString* ServingNode::set3GPPAAAServerName(){
	mMandatoryAvpSetVal [ServingNode_3GPPAAASERVERNAME] = 1;
	if(m3GPPAAAServerName == NULL)
	{
		m3GPPAAAServerName = new OctetString();
		mTagsPresent[ServingNode_3GPPAAASERVERNAME] = 1;
		return m3GPPAAAServerName;
	}
	return m3GPPAAAServerName;
}

void ServingNode::reset3GPPAAAServerName(){
	mTagsPresent[ServingNode_3GPPAAASERVERNAME] = 0;
	if(m3GPPAAAServerName != NULL)
	{
		delete m3GPPAAAServerName; 
		m3GPPAAAServerName = NULL;
...
Unsigned32* ServingNode::setLCSCapabilitiesSets(){
	mMandatoryAvpSetVal [ServingNode_LCSCAPABILITIESSETS] = 1;
	if(mLCSCapabilitiesSets == NULL)
	{
		mLCSCapabilitiesSets = new Unsigned32();
		mTagsPresent[ServingNode_LCSCAPABILITIESSETS] = 1;
		return mLCSCapabilitiesSets;
	}
	return mLCSCapabilitiesSets;
}

void ServingNode::resetLCSCapabilitiesSets(){
	mTagsPresent[ServingNode_LCSCAPABILITIESSETS] = 0;
	if(mLCSCapabilitiesSets != NULL)
	{
		delete mLCSCapabilitiesSets; 
		mLCSCapabilitiesSets = NULL;
...
OctetString* ServingNode::getSGSNNumber(){
	if(NULL == mSGSNNumber) {
...
OctetString* ServingNode::getSGSNName(){
	if(NULL == mSGSNName) {
...
OctetString* ServingNode::getSGSNRealm(){
	if(NULL == mSGSNRealm) {
...
OctetString* ServingNode::getMMEName(){
	if(NULL == mMMEName) {
...
OctetString* ServingNode::getMMERealm(){
	if(NULL == mMMERealm) {
...
OctetString* ServingNode::getMSCNumber(){
	if(NULL == mMSCNumber) {
...
OctetString* ServingNode::get3GPPAAAServerName(){
...
Unsigned32* ServingNode::getLCSCapabilitiesSets(){
...
list<OctetString*>* ServingNode::getGMLCAddressList()
{
	if(mGMLCAddressList == NULL)
	{
...
list<OctetString*>* ServingNode::setGMLCAddressList() {
	mTagsPresent[ServingNode_GMLCADDRESS] = 1;
	if(mGMLCAddressList == NULL)
		mGMLCAddressList = new list<OctetString*>;
	mMandatoryAvpSetVal [ServingNode_GMLCADDRESS] = 1;
	mGMLCAddressList->clear();
	return mGMLCAddressList;
}

void ServingNode::resetGMLCAddressList(){
	mTagsPresent[ServingNode_GMLCADDRESS] = 0;
	if(mGMLCAddressList != NULL)
		delete mGMLCAddressList;
}
...
int ServingNode::Encode(byteArray *array)
{
	...
	for(unsigned int i = 0 ; i < mTagsPresent.size() ; ++i )
	{
		...
		switch(i)
		{
			...
			case ServingNode_MSCNUMBER:
			{
				...
				break;
			case ServingNode_3GPPAAASERVERNAME:
			{
					array->size+=4;
				...
				break;
			case ServingNode_LCSCAPABILITIESSETS:
			{
					array->size+=4;
...
int ServingNode::Decode(byteArray *array, INT16 lMsgLen, UINT16 *parsedBytes)
{
	mDecodeFlag = true;
	while( lMsgLen > 0)
	{
...
DiameterBaseInterface* ServingNode::Find(byteArray *array, UINT32 avpCode)
{
...
BOOLEAN ServingNode::FindAll(byteArray *array, UINT32 avpCode, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
	if(!this->mAvpDecodedFlag)
	{
		this->mspByteArray.get()->offset = 0;
...
std::shared_ptr<byteArray> ServingNode::GetByteArray()
{
	return mspByteArray;
}


BOOLEAN ServingNode::FindAll(byteArray *array, std::map<int,UINT32> &avpCodeMap, int &size, int key, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
	if(!this->mAvpDecodedFlag)
	{
		this->mspByteArray.get()->offset = 0;
...
INT32 ServingNode::setAvpCode(UINT32 avpCode)
{
	mAvpCode = avpCode;
	return 0;
}
UINT32 ServingNode::getAvpCode()
{
	return mAvpCode;
}
INT32 ServingNode::setAvpVendorId(UINT32 avpVendorId)
{
	mAvpVendorId = avpVendorId;
	return 0;
}
UINT32 ServingNode::getAvpVendorId()
{
	return mAvpVendorId;
}
INT32 ServingNode::setAvpOffsetLen(INT16 offset, INT16 length)
{
	mAvpOffsetLen = make_pair(offset,length);
	return 0;
}
pair<INT16,INT16> ServingNode::getAvpOffsetLen()
{
...
void ServingNode::Display(UINT32 tab)
{
	int tempTab = tab * 3; 
...
BOOLEAN ServingNode::GetMissingAvpInfo(TEXT *lMissingAvpInfo)
{
