...
using namespace SH;
BOOLEAN UserDataAnswer::isPresent(int tag){
	return (mTagsPresent[tag])?true:false;
}

UserDataAnswer::UserDataAnswer()
{
	mSessionId = NULL;
	mDRMP = NULL;
	...
	mTagsPresent.reset();
	mMandatoryAvpCheckVal= bitset<18>(string("111000100011111101"));
...
OctetString* UserDataAnswer::setSessionId(){
	mMandatoryAvpSetVal [UserDataAnswer_SESSIONID] = 1;
	if(mSessionId == NULL)
	{
		mSessionId = new OctetString();
		mTagsPresent[UserDataAnswer_SESSIONID] = 1;
		return mSessionId;
	}
	return mSessionId;
}

void UserDataAnswer::resetSessionId(){
	mTagsPresent[UserDataAnswer_SESSIONID] = 0;
	if(mSessionId != NULL)
	{
		delete mSessionId; 
		mSessionId = NULL;
...
DRMP* UserDataAnswer::setDRMP(){
	if(mDRMP == NULL)
	{
		mDRMP = new DRMP();
		mTagsPresent[UserDataAnswer_DRMP] = 1;
		return mDRMP;
	}
	return mDRMP;
}

void UserDataAnswer::resetDRMP(){
	mTagsPresent[UserDataAnswer_DRMP] = 0;
	if(mDRMP != NULL)
	{
		delete mDRMP; 
		mDRMP = NULL;
...
Unsigned32* UserDataAnswer::setResultCode(){
	mMandatoryAvpSetVal [UserDataAnswer_RESULTCODE] = 1;
	if(mResultCode == NULL)
	{
		mResultCode = new Unsigned32();
		mTagsPresent[UserDataAnswer_RESULTCODE] = 1;
		return mResultCode;
	}
	return mResultCode;
}

void UserDataAnswer::resetResultCode(){
	mTagsPresent[UserDataAnswer_RESULTCODE] = 0;
	if(mResultCode != NULL)
	{
		delete mResultCode; 
		mResultCode = NULL;
...
AuthSessionState* UserDataAnswer::setAuthSessionState(){
	mMandatoryAvpSetVal [UserDataAnswer_AUTHSESSIONSTATE] = 1;
	if(mAuthSessionState == NULL)
	{
		mAuthSessionState = new AuthSessionState();
		mTagsPresent[UserDataAnswer_AUTHSESSIONSTATE] = 1;
		return mAuthSessionState;
	}
	return mAuthSessionState;
}

void UserDataAnswer::resetAuthSessionState(){
	mTagsPresent[UserDataAnswer_AUTHSESSIONSTATE] = 0;
	if(mAuthSessionState != NULL)
	{
		delete mAuthSessionState; 
		mAuthSessionState = NULL;
...
OctetString* UserDataAnswer::setOriginHost(){
	mMandatoryAvpSetVal [UserDataAnswer_ORIGINHOST] = 1;
	if(mOriginHost == NULL)
	{
		mOriginHost = new OctetString();
		mTagsPresent[UserDataAnswer_ORIGINHOST] = 1;
		return mOriginHost;
	}
	return mOriginHost;
}

void UserDataAnswer::resetOriginHost(){
	mTagsPresent[UserDataAnswer_ORIGINHOST] = 0;
	if(mOriginHost != NULL)
	{
		delete mOriginHost; 
		mOriginHost = NULL;
...
OctetString* UserDataAnswer::setOriginRealm(){
	mMandatoryAvpSetVal [UserDataAnswer_ORIGINREALM] = 1;
	if(mOriginRealm == NULL)
	{
		mOriginRealm = new OctetString();
		mTagsPresent[UserDataAnswer_ORIGINREALM] = 1;
		return mOriginRealm;
	}
	return mOriginRealm;
}

void UserDataAnswer::resetOriginRealm(){
	mTagsPresent[UserDataAnswer_ORIGINREALM] = 0;
	if(mOriginRealm != NULL)
	{
		delete mOriginRealm; 
		mOriginRealm = NULL;
...
OctetString* UserDataAnswer::setWildcardedPublicIdentity(){
	if(mWildcardedPublicIdentity == NULL)
	{
		mWildcardedPublicIdentity = new OctetString();
		mTagsPresent[UserDataAnswer_WILDCARDEDPUBLICIDENTITY] = 1;
		return mWildcardedPublicIdentity;
	}
	return mWildcardedPublicIdentity;
}

void UserDataAnswer::resetWildcardedPublicIdentity(){
	mTagsPresent[UserDataAnswer_WILDCARDEDPUBLICIDENTITY] = 0;
	if(mWildcardedPublicIdentity != NULL)
	{
		delete mWildcardedPublicIdentity; 
		mWildcardedPublicIdentity = NULL;
...
OctetString* UserDataAnswer::setWildcardedIMPU(){
	if(mWildcardedIMPU == NULL)
	{
		mWildcardedIMPU = new OctetString();
		mTagsPresent[UserDataAnswer_WILDCARDEDIMPU] = 1;
		return mWildcardedIMPU;
	}
	return mWildcardedIMPU;
}

void UserDataAnswer::resetWildcardedIMPU(){
	mTagsPresent[UserDataAnswer_WILDCARDEDIMPU] = 0;
	if(mWildcardedIMPU != NULL)
	{
		delete mWildcardedIMPU; 
		mWildcardedIMPU = NULL;
...
OctetString* UserDataAnswer::setUserData(){
	mMandatoryAvpSetVal [UserDataAnswer_USERDATA] = 1;
	if(mUserData == NULL)
	{
		mUserData = new OctetString();
		mTagsPresent[UserDataAnswer_USERDATA] = 1;
		return mUserData;
	}
	return mUserData;
}

void UserDataAnswer::resetUserData(){
	mTagsPresent[UserDataAnswer_USERDATA] = 0;
	if(mUserData != NULL)
	{
		delete mUserData; 
		mUserData = NULL;
...
OctetString* UserDataAnswer::getSessionId(){
	if(NULL == mSessionId) {
...
SH::VendorSpecificApplicationId* UserDataAnswer::getVendorSpecificApplicationId()
{
	if(mVendorSpecificApplicationIdGrp == NULL)
	{
...
SH::VendorSpecificApplicationId* UserDataAnswer::setVendorSpecificApplicationId(){
	if(mVendorSpecificApplicationIdGrp == NULL)
		mVendorSpecificApplicationIdGrp = new VendorSpecificApplicationId();
	mTagsPresent[UserDataAnswer_VENDORSPECIFICAPPLICATIONID] = 1;
	mMandatoryAvpSetVal[UserDataAnswer_VENDORSPECIFICAPPLICATIONID] = 1;
	return mVendorSpecificApplicationIdGrp;
}

void UserDataAnswer::resetVendorSpecificApplicationId(){
	mTagsPresent[UserDataAnswer_VENDORSPECIFICAPPLICATIONID] = 0;
	if(mVendorSpecificApplicationIdGrp != NULL)
		delete mVendorSpecificApplicationIdGrp;
}

Unsigned32* UserDataAnswer::getResultCode(){
	if(NULL == mResultCode) {
...
ExperimentalResult* UserDataAnswer::getExperimentalResult()
{
	if(mExperimentalResultGrp == NULL)
	{
...
ExperimentalResult* UserDataAnswer::setExperimentalResult(){
	if(mExperimentalResultGrp == NULL)
		mExperimentalResultGrp = new ExperimentalResult();
	mTagsPresent[UserDataAnswer_EXPERIMENTALRESULT] = 1;
	mMandatoryAvpSetVal[UserDataAnswer_EXPERIMENTALRESULT] = 1;
	return mExperimentalResultGrp;
}

void UserDataAnswer::resetExperimentalResult(){
	mTagsPresent[UserDataAnswer_EXPERIMENTALRESULT] = 0;
	if(mExperimentalResultGrp != NULL)
		delete mExperimentalResultGrp;
}

AuthSessionState* UserDataAnswer::getAuthSessionState(){
...
OctetString* UserDataAnswer::getOriginHost(){
	if(NULL == mOriginHost) {
...
OctetString* UserDataAnswer::getOriginRealm(){
...
list<SupportedFeatures*>* UserDataAnswer::getSupportedFeaturesGrpList()
{
	if(mSupportedFeaturesGrpList == NULL)
	{
	...
	for(auto itr : *mSupportedFeaturesGrpList)
	{
		...
		{
			mTagsPresent[UserDataAnswer_SUPPORTEDFEATURES] = 0;
			mSupportedFeaturesGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "SupportedFeatures is Null");
			throw lTssDiaMsgException;
		}
...
list<SupportedFeatures*>* UserDataAnswer::setSupportedFeaturesGrpList(){
	mTagsPresent[UserDataAnswer_SUPPORTEDFEATURES] = 1;
	if(mSupportedFeaturesGrpList == NULL)
...
void UserDataAnswer::resetSupportedFeaturesGrpList(){
	mTagsPresent[UserDataAnswer_SUPPORTEDFEATURES] = 0;
	if(mSupportedFeaturesGrpList != NULL)
		delete mSupportedFeaturesGrpList;
}

OctetString* UserDataAnswer::getWildcardedPublicIdentity(){
...
OctetString* UserDataAnswer::getWildcardedIMPU(){
...
OctetString* UserDataAnswer::getUserData(){
	if(NULL == mUserData) {
...
OCSupportedFeatures* UserDataAnswer::getOCSupportedFeatures()
{
	if(mOCSupportedFeaturesGrp == NULL)
	{
...
OCSupportedFeatures* UserDataAnswer::setOCSupportedFeatures(){
	if(mOCSupportedFeaturesGrp == NULL)
		mOCSupportedFeaturesGrp = new OCSupportedFeatures();
	mTagsPresent[UserDataAnswer_OCSUPPORTEDFEATURES] = 1;
	return mOCSupportedFeaturesGrp;
}

void UserDataAnswer::resetOCSupportedFeatures(){
	mTagsPresent[UserDataAnswer_OCSUPPORTEDFEATURES] = 0;
	if(mOCSupportedFeaturesGrp != NULL)
		delete mOCSupportedFeaturesGrp;
}

OCOLR* UserDataAnswer::getOCOLR()
{
	if(mOCOLRGrp == NULL)
	{
...
OCOLR* UserDataAnswer::setOCOLR(){
	if(mOCOLRGrp == NULL)
		mOCOLRGrp = new OCOLR();
	mTagsPresent[UserDataAnswer_OCOLR] = 1;
	return mOCOLRGrp;
}

void UserDataAnswer::resetOCOLR(){
	mTagsPresent[UserDataAnswer_OCOLR] = 0;
	if(mOCOLRGrp != NULL)
		delete mOCOLRGrp;
}

list<Load*>* UserDataAnswer::getLoadGrpList()
{
	if(mLoadGrpList == NULL)
	{
	...
	for(auto itr : *mLoadGrpList)
	{
		...
		{
			mTagsPresent[UserDataAnswer_LOAD] = 0;
			mLoadGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "Load is Null");
			throw lTssDiaMsgException;
		}
...
list<Load*>* UserDataAnswer::setLoadGrpList(){
	mTagsPresent[UserDataAnswer_LOAD] = 1;
	if(mLoadGrpList == NULL)
...
void UserDataAnswer::resetLoadGrpList(){
	mTagsPresent[UserDataAnswer_LOAD] = 0;
	if(mLoadGrpList != NULL)
		delete mLoadGrpList;
}

FailedAVP* UserDataAnswer::getFailedAVP()
{
	if(mFailedAVPGrp == NULL)
	{
...
FailedAVP* UserDataAnswer::setFailedAVP(){
	if(mFailedAVPGrp == NULL)
		mFailedAVPGrp = new FailedAVP();
	mTagsPresent[UserDataAnswer_FAILEDAVP] = 1;
	mMandatoryAvpSetVal[UserDataAnswer_FAILEDAVP] = 1;
	return mFailedAVPGrp;
}

void UserDataAnswer::resetFailedAVP(){
	mTagsPresent[UserDataAnswer_FAILEDAVP] = 0;
	if(mFailedAVPGrp != NULL)
		delete mFailedAVPGrp;
}

list<SH::ProxyInfo*>* UserDataAnswer::getProxyInfoGrpList()
{
	if(mProxyInfoGrpList == NULL)
	{
	...
	for(auto itr : *mProxyInfoGrpList)
	{
		...
		{
			mTagsPresent[UserDataAnswer_PROXYINFO] = 0;
			mProxyInfoGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "ProxyInfo is Null");
			throw lTssDiaMsgException;
		}
...
list<SH::ProxyInfo*>* UserDataAnswer::setProxyInfoGrpList(){
	mTagsPresent[UserDataAnswer_PROXYINFO] = 1;
	if(mProxyInfoGrpList == NULL)
		mProxyInfoGrpList = new list<SH::ProxyInfo*>;
	mMandatoryAvpSetVal[UserDataAnswer_PROXYINFO] = 1;
	mProxyInfoGrpList->clear();
	return mProxyInfoGrpList;
}

void UserDataAnswer::resetProxyInfoGrpList(){
	mTagsPresent[UserDataAnswer_PROXYINFO] = 0;
	if(mProxyInfoGrpList != NULL)
		delete mProxyInfoGrpList;
}

list<OctetString*>* UserDataAnswer::getRouteRecordList()
{
	if(mRouteRecordList == NULL)
	{
...
list<OctetString*>* UserDataAnswer::setRouteRecordList() {
	mTagsPresent[UserDataAnswer_ROUTERECORD] = 1;
	if(mRouteRecordList == NULL)
		mRouteRecordList = new list<OctetString*>;
	mMandatoryAvpSetVal [UserDataAnswer_ROUTERECORD] = 1;
	mRouteRecordList->clear();
	return mRouteRecordList;
}

void UserDataAnswer::resetRouteRecordList(){
	mTagsPresent[UserDataAnswer_ROUTERECORD] = 0;
	if(mRouteRecordList != NULL)
		delete mRouteRecordList;
}
...
int UserDataAnswer::Encode(byteArray *array)
{
	...
	for(unsigned int i = 0 ; i < mTagsPresent.size() ; ++i )
	{
		...
		switch(i)
		{
			...
			case UserDataAnswer_DRMP:
			{
				...
				break;
			case UserDataAnswer_VENDORSPECIFICAPPLICATIONID:
			{
				array->size+=4;
				...
				break;
			case UserDataAnswer_RESULTCODE:
			{
					array->size+=4;
				...
				break;
			case UserDataAnswer_EXPERIMENTALRESULT:
			{
				array->size+=4;
				...
				break;
			case UserDataAnswer_AUTHSESSIONSTATE:
			{
					array->size+=4;
				...
				break;
			case UserDataAnswer_ORIGINHOST:
			{
					array->size+=4;
				...
				break;
			case UserDataAnswer_ORIGINREALM:
			{
					array->size+=4;
				...
				break;
			case UserDataAnswer_SUPPORTEDFEATURES:
			{
				if( mSupportedFeaturesGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case UserDataAnswer_WILDCARDEDPUBLICIDENTITY:
			{
					array->size+=4;
				...
				break;
			case UserDataAnswer_WILDCARDEDIMPU:
			{
					array->size+=4;
			...
			case UserDataAnswer_USERDATA:
			{
				...
				break;
			case UserDataAnswer_OCSUPPORTEDFEATURES:
			{
				array->size+=4;
			...
			case UserDataAnswer_PROXYINFO:
			{
				...
				break;
			case UserDataAnswer_ROUTERECORD:
			{
...
int UserDataAnswer::Decode(byteArray *array, INT16 lMLen, UINT16 *parsedBytes)
{
...
DiameterBaseInterface* UserDataAnswer::Find(byteArray *array, UINT32 avpCode)
{
...
BOOLEAN UserDataAnswer::FindAll(byteArray *array, UINT32 avpCode, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
std::shared_ptr<byteArray> UserDataAnswer::GetByteArray()
{
	return mspByteArray;
}


BOOLEAN UserDataAnswer::FindAll(byteArray *array, std::map<int,UINT32> &avpCodeMap, int &size, int key, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
void UserDataAnswer::Display(UINT32 tab)
{
...
BOOLEAN UserDataAnswer::GetMissingAvpInfo(TEXT *lMissingAvpInfo)
{
