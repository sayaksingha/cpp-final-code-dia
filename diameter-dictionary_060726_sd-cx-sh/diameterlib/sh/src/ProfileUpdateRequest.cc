...
using namespace SH;
BOOLEAN ProfileUpdateRequest::isPresent(int tag){
...
ProfileUpdateRequest::ProfileUpdateRequest()
{
	...
	mTagsPresent.reset();
	mMandatoryAvpCheckVal= bitset<18>(string("110111001011111101"));
...
OctetString* ProfileUpdateRequest::setSessionId(){
	mMandatoryAvpSetVal [ProfileUpdateRequest_SESSIONID] = 1;
	if(mSessionId == NULL)
	{
		mSessionId = new OctetString();
		mTagsPresent[ProfileUpdateRequest_SESSIONID] = 1;
		return mSessionId;
	}
	return mSessionId;
}

void ProfileUpdateRequest::resetSessionId(){
	mTagsPresent[ProfileUpdateRequest_SESSIONID] = 0;
	if(mSessionId != NULL)
	{
		delete mSessionId; 
		mSessionId = NULL;
...
DRMP* ProfileUpdateRequest::setDRMP(){
	if(mDRMP == NULL)
	{
		mDRMP = new DRMP();
		mTagsPresent[ProfileUpdateRequest_DRMP] = 1;
		return mDRMP;
	}
	return mDRMP;
}

void ProfileUpdateRequest::resetDRMP(){
	mTagsPresent[ProfileUpdateRequest_DRMP] = 0;
	if(mDRMP != NULL)
	{
		delete mDRMP; 
		mDRMP = NULL;
...
AuthSessionState* ProfileUpdateRequest::setAuthSessionState(){
	mMandatoryAvpSetVal [ProfileUpdateRequest_AUTHSESSIONSTATE] = 1;
	if(mAuthSessionState == NULL)
	{
		mAuthSessionState = new AuthSessionState();
		mTagsPresent[ProfileUpdateRequest_AUTHSESSIONSTATE] = 1;
		return mAuthSessionState;
	}
	return mAuthSessionState;
}

void ProfileUpdateRequest::resetAuthSessionState(){
	mTagsPresent[ProfileUpdateRequest_AUTHSESSIONSTATE] = 0;
	if(mAuthSessionState != NULL)
	{
		delete mAuthSessionState; 
		mAuthSessionState = NULL;
...
OctetString* ProfileUpdateRequest::setOriginHost(){
	mMandatoryAvpSetVal [ProfileUpdateRequest_ORIGINHOST] = 1;
	if(mOriginHost == NULL)
	{
		mOriginHost = new OctetString();
		mTagsPresent[ProfileUpdateRequest_ORIGINHOST] = 1;
		return mOriginHost;
	}
	return mOriginHost;
}

void ProfileUpdateRequest::resetOriginHost(){
	mTagsPresent[ProfileUpdateRequest_ORIGINHOST] = 0;
	if(mOriginHost != NULL)
	{
		delete mOriginHost; 
		mOriginHost = NULL;
...
OctetString* ProfileUpdateRequest::setOriginRealm(){
	mMandatoryAvpSetVal [ProfileUpdateRequest_ORIGINREALM] = 1;
	if(mOriginRealm == NULL)
	{
		mOriginRealm = new OctetString();
		mTagsPresent[ProfileUpdateRequest_ORIGINREALM] = 1;
		return mOriginRealm;
	}
	return mOriginRealm;
}

void ProfileUpdateRequest::resetOriginRealm(){
	mTagsPresent[ProfileUpdateRequest_ORIGINREALM] = 0;
	if(mOriginRealm != NULL)
	{
		delete mOriginRealm; 
		mOriginRealm = NULL;
...
OctetString* ProfileUpdateRequest::setDestinationHost(){
	mMandatoryAvpSetVal [ProfileUpdateRequest_DESTINATIONHOST] = 1;
	if(mDestinationHost == NULL)
	{
		mDestinationHost = new OctetString();
		mTagsPresent[ProfileUpdateRequest_DESTINATIONHOST] = 1;
		return mDestinationHost;
	}
	return mDestinationHost;
}

void ProfileUpdateRequest::resetDestinationHost(){
	mTagsPresent[ProfileUpdateRequest_DESTINATIONHOST] = 0;
	if(mDestinationHost != NULL)
	{
		delete mDestinationHost; 
		mDestinationHost = NULL;
...
OctetString* ProfileUpdateRequest::setDestinationRealm(){
	mMandatoryAvpSetVal [ProfileUpdateRequest_DESTINATIONREALM] = 1;
	if(mDestinationRealm == NULL)
	{
		mDestinationRealm = new OctetString();
		mTagsPresent[ProfileUpdateRequest_DESTINATIONREALM] = 1;
		return mDestinationRealm;
	}
	return mDestinationRealm;
}

void ProfileUpdateRequest::resetDestinationRealm(){
	mTagsPresent[ProfileUpdateRequest_DESTINATIONREALM] = 0;
	if(mDestinationRealm != NULL)
	{
		delete mDestinationRealm; 
		mDestinationRealm = NULL;
...
OctetString* ProfileUpdateRequest::setWildcardedPublicIdentity(){
	if(mWildcardedPublicIdentity == NULL)
	{
		mWildcardedPublicIdentity = new OctetString();
		mTagsPresent[ProfileUpdateRequest_WILDCARDEDPUBLICIDENTITY] = 1;
		return mWildcardedPublicIdentity;
	}
	return mWildcardedPublicIdentity;
}

void ProfileUpdateRequest::resetWildcardedPublicIdentity(){
	mTagsPresent[ProfileUpdateRequest_WILDCARDEDPUBLICIDENTITY] = 0;
	if(mWildcardedPublicIdentity != NULL)
	{
		delete mWildcardedPublicIdentity; 
		mWildcardedPublicIdentity = NULL;
...
OctetString* ProfileUpdateRequest::setWildcardedIMPU(){
	if(mWildcardedIMPU == NULL)
	{
		mWildcardedIMPU = new OctetString();
		mTagsPresent[ProfileUpdateRequest_WILDCARDEDIMPU] = 1;
		return mWildcardedIMPU;
	}
	return mWildcardedIMPU;
}

void ProfileUpdateRequest::resetWildcardedIMPU(){
	mTagsPresent[ProfileUpdateRequest_WILDCARDEDIMPU] = 0;
	if(mWildcardedIMPU != NULL)
	{
		delete mWildcardedIMPU; 
		mWildcardedIMPU = NULL;
...
OctetString* ProfileUpdateRequest::setUserName(){
	mMandatoryAvpSetVal [ProfileUpdateRequest_USERNAME] = 1;
	if(mUserName == NULL)
	{
		mUserName = new OctetString();
		mTagsPresent[ProfileUpdateRequest_USERNAME] = 1;
		return mUserName;
	}
	return mUserName;
}

void ProfileUpdateRequest::resetUserName(){
	mTagsPresent[ProfileUpdateRequest_USERNAME] = 0;
	if(mUserName != NULL)
	{
		delete mUserName; 
		mUserName = NULL;
...
OctetString* ProfileUpdateRequest::setUserData(){
	mMandatoryAvpSetVal [ProfileUpdateRequest_USERDATA] = 1;
	if(mUserData == NULL)
	{
		mUserData = new OctetString();
		mTagsPresent[ProfileUpdateRequest_USERDATA] = 1;
		return mUserData;
	}
	return mUserData;
}

void ProfileUpdateRequest::resetUserData(){
	mTagsPresent[ProfileUpdateRequest_USERDATA] = 0;
	if(mUserData != NULL)
	{
		delete mUserData; 
		mUserData = NULL;
...
OctetString* ProfileUpdateRequest::getSessionId(){
	if(NULL == mSessionId) {
...
DRMP* ProfileUpdateRequest::getDRMP(){
	if(NULL == mDRMP) {
...
SH::VendorSpecificApplicationId* ProfileUpdateRequest::getVendorSpecificApplicationId()
{
	if(mVendorSpecificApplicationIdGrp == NULL)
	{
...
SH::VendorSpecificApplicationId* ProfileUpdateRequest::setVendorSpecificApplicationId(){
	if(mVendorSpecificApplicationIdGrp == NULL)
		mVendorSpecificApplicationIdGrp = new VendorSpecificApplicationId();
	mTagsPresent[ProfileUpdateRequest_VENDORSPECIFICAPPLICATIONID] = 1;
	mMandatoryAvpSetVal[ProfileUpdateRequest_VENDORSPECIFICAPPLICATIONID] = 1;
	return mVendorSpecificApplicationIdGrp;
}

void ProfileUpdateRequest::resetVendorSpecificApplicationId(){
	mTagsPresent[ProfileUpdateRequest_VENDORSPECIFICAPPLICATIONID] = 0;
	if(mVendorSpecificApplicationIdGrp != NULL)
		delete mVendorSpecificApplicationIdGrp;
}

AuthSessionState* ProfileUpdateRequest::getAuthSessionState(){
...
OctetString* ProfileUpdateRequest::getOriginHost(){
	if(NULL == mOriginHost) {
...
OctetString* ProfileUpdateRequest::getOriginRealm(){
...
OctetString* ProfileUpdateRequest::getDestinationHost(){
...
OctetString* ProfileUpdateRequest::getDestinationRealm(){
...
list<SupportedFeatures*>* ProfileUpdateRequest::getSupportedFeaturesGrpList()
{
	if(mSupportedFeaturesGrpList == NULL)
	{
	...
	for(auto itr : *mSupportedFeaturesGrpList)
	{
		...
		{
			mTagsPresent[ProfileUpdateRequest_SUPPORTEDFEATURES] = 0;
			mSupportedFeaturesGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "SupportedFeatures is Null");
			throw lTssDiaMsgException;
		}
...
list<SupportedFeatures*>* ProfileUpdateRequest::setSupportedFeaturesGrpList(){
	mTagsPresent[ProfileUpdateRequest_SUPPORTEDFEATURES] = 1;
	if(mSupportedFeaturesGrpList == NULL)
...
void ProfileUpdateRequest::resetSupportedFeaturesGrpList(){
	mTagsPresent[ProfileUpdateRequest_SUPPORTEDFEATURES] = 0;
	if(mSupportedFeaturesGrpList != NULL)
		delete mSupportedFeaturesGrpList;
}

UserIdentity* ProfileUpdateRequest::getUserIdentity()
{
	if(mUserIdentityGrp == NULL)
	{
...
UserIdentity* ProfileUpdateRequest::setUserIdentity(){
	if(mUserIdentityGrp == NULL)
		mUserIdentityGrp = new UserIdentity();
	mTagsPresent[ProfileUpdateRequest_USERIDENTITY] = 1;
	mMandatoryAvpSetVal[ProfileUpdateRequest_USERIDENTITY] = 1;
	return mUserIdentityGrp;
}

void ProfileUpdateRequest::resetUserIdentity(){
	mTagsPresent[ProfileUpdateRequest_USERIDENTITY] = 0;
	if(mUserIdentityGrp != NULL)
		delete mUserIdentityGrp;
}

OctetString* ProfileUpdateRequest::getWildcardedPublicIdentity(){
...
OctetString* ProfileUpdateRequest::getWildcardedIMPU(){
...
OctetString* ProfileUpdateRequest::getUserName(){
	if(NULL == mUserName) {
...
list<DataReference*>* ProfileUpdateRequest::getDataReferenceList()
{
	if(mDataReferenceList == NULL)
	{
...
list<DataReference*>* ProfileUpdateRequest::setDataReferenceList() {
	mTagsPresent[ProfileUpdateRequest_DATAREFERENCE] = 1;
	if(mDataReferenceList == NULL)
		mDataReferenceList = new list<DataReference*>;
	mMandatoryAvpSetVal [ProfileUpdateRequest_DATAREFERENCE] = 1;
	mDataReferenceList->clear();
	return mDataReferenceList;
}

void ProfileUpdateRequest::resetDataReferenceList(){
	mTagsPresent[ProfileUpdateRequest_DATAREFERENCE] = 0;
	if(mDataReferenceList != NULL)
		delete mDataReferenceList;
}

OctetString* ProfileUpdateRequest::getUserData(){
	if(NULL == mUserData) {
...
OCSupportedFeatures* ProfileUpdateRequest::getOCSupportedFeatures()
{
	if(mOCSupportedFeaturesGrp == NULL)
	{
...
OCSupportedFeatures* ProfileUpdateRequest::setOCSupportedFeatures(){
	if(mOCSupportedFeaturesGrp == NULL)
		mOCSupportedFeaturesGrp = new OCSupportedFeatures();
	mTagsPresent[ProfileUpdateRequest_OCSUPPORTEDFEATURES] = 1;
	return mOCSupportedFeaturesGrp;
}

void ProfileUpdateRequest::resetOCSupportedFeatures(){
	mTagsPresent[ProfileUpdateRequest_OCSUPPORTEDFEATURES] = 0;
	if(mOCSupportedFeaturesGrp != NULL)
		delete mOCSupportedFeaturesGrp;
}

list<SH::ProxyInfo*>* ProfileUpdateRequest::getProxyInfoGrpList()
{
	if(mProxyInfoGrpList == NULL)
	{
	...
	for(auto itr : *mProxyInfoGrpList)
	{
		...
		{
			mTagsPresent[ProfileUpdateRequest_PROXYINFO] = 0;
			mProxyInfoGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "ProxyInfo is Null");
			throw lTssDiaMsgException;
		}
...
list<SH::ProxyInfo*>* ProfileUpdateRequest::setProxyInfoGrpList(){
	mTagsPresent[ProfileUpdateRequest_PROXYINFO] = 1;
	if(mProxyInfoGrpList == NULL)
		mProxyInfoGrpList = new list<SH::ProxyInfo*>;
	mMandatoryAvpSetVal[ProfileUpdateRequest_PROXYINFO] = 1;
	mProxyInfoGrpList->clear();
	return mProxyInfoGrpList;
}

void ProfileUpdateRequest::resetProxyInfoGrpList(){
	mTagsPresent[ProfileUpdateRequest_PROXYINFO] = 0;
	if(mProxyInfoGrpList != NULL)
		delete mProxyInfoGrpList;
}

list<OctetString*>* ProfileUpdateRequest::getRouteRecordList()
{
	if(mRouteRecordList == NULL)
	{
...
list<OctetString*>* ProfileUpdateRequest::setRouteRecordList() {
	mTagsPresent[ProfileUpdateRequest_ROUTERECORD] = 1;
	if(mRouteRecordList == NULL)
		mRouteRecordList = new list<OctetString*>;
	mMandatoryAvpSetVal [ProfileUpdateRequest_ROUTERECORD] = 1;
	mRouteRecordList->clear();
	return mRouteRecordList;
}

void ProfileUpdateRequest::resetRouteRecordList(){
	mTagsPresent[ProfileUpdateRequest_ROUTERECORD] = 0;
	if(mRouteRecordList != NULL)
		delete mRouteRecordList;
}
...
int ProfileUpdateRequest::Encode(byteArray *array)
{
	...
	for(unsigned int i = 0 ; i < mTagsPresent.size() ; ++i )
	{
		...
		switch(i)
		{
			case ProfileUpdateRequest_SESSIONID:
			{
					array->size+=4;
				...
				break;
			case ProfileUpdateRequest_DRMP:
			{
					array->size+=4;
				...
				break;
			case ProfileUpdateRequest_VENDORSPECIFICAPPLICATIONID:
			{
				array->size+=4;
				...
				break;
			case ProfileUpdateRequest_AUTHSESSIONSTATE:
			{
					array->size+=4;
				...
				break;
			case ProfileUpdateRequest_ORIGINHOST:
			{
					array->size+=4;
				...
				break;
			case ProfileUpdateRequest_ORIGINREALM:
			{
					array->size+=4;
				...
				break;
			case ProfileUpdateRequest_DESTINATIONHOST:
			{
					array->size+=4;
				...
				break;
			case ProfileUpdateRequest_DESTINATIONREALM:
			{
					array->size+=4;
				...
				break;
			case ProfileUpdateRequest_SUPPORTEDFEATURES:
			{
				if( mSupportedFeaturesGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case ProfileUpdateRequest_USERIDENTITY:
			{
				array->size+=4;
				...
				break;
			case ProfileUpdateRequest_WILDCARDEDPUBLICIDENTITY:
			{
					array->size+=4;
				...
				break;
			case ProfileUpdateRequest_WILDCARDEDIMPU:
			{
					array->size+=4;
				...
				break;
			case ProfileUpdateRequest_USERNAME:
			{
					array->size+=4;
				...
				break;
			case ProfileUpdateRequest_DATAREFERENCE:
			{
				...
				break;
			case ProfileUpdateRequest_USERDATA:
			{
					array->size+=4;
				...
				break;
			case ProfileUpdateRequest_OCSUPPORTEDFEATURES:
			{
				array->size+=4;
				...
				break;
			case ProfileUpdateRequest_PROXYINFO:
			{
				if( mProxyInfoGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case ProfileUpdateRequest_ROUTERECORD:
			{
...
int ProfileUpdateRequest::Decode(byteArray *array, INT16 lMLen, UINT16 *parsedBytes)
{
...
DiameterBaseInterface* ProfileUpdateRequest::Find(byteArray *array, UINT32 avpCode)
{
...
BOOLEAN ProfileUpdateRequest::FindAll(byteArray *array, UINT32 avpCode, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
std::shared_ptr<byteArray> ProfileUpdateRequest::GetByteArray()
{
	return mspByteArray;
}


BOOLEAN ProfileUpdateRequest::FindAll(byteArray *array, std::map<int,UINT32> &avpCodeMap, int &size, int key, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
void ProfileUpdateRequest::Display(UINT32 tab)
{
...
BOOLEAN ProfileUpdateRequest::GetMissingAvpInfo(TEXT *lMissingAvpInfo)
{
