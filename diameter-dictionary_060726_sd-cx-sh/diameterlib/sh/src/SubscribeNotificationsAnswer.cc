...
using namespace SH;
BOOLEAN SubscribeNotificationsAnswer::isPresent(int tag){
	return (mTagsPresent[tag])?true:false;
}

SubscribeNotificationsAnswer::SubscribeNotificationsAnswer()
{
	mSessionId = NULL;
	mDRMP = NULL;
...
OctetString* SubscribeNotificationsAnswer::setSessionId(){
	mMandatoryAvpSetVal [SubscribeNotificationsAnswer_SESSIONID] = 1;
	if(mSessionId == NULL)
	{
		mSessionId = new OctetString();
		mTagsPresent[SubscribeNotificationsAnswer_SESSIONID] = 1;
		return mSessionId;
	}
	return mSessionId;
}

void SubscribeNotificationsAnswer::resetSessionId(){
	mTagsPresent[SubscribeNotificationsAnswer_SESSIONID] = 0;
	if(mSessionId != NULL)
	{
		delete mSessionId; 
		mSessionId = NULL;
...
DRMP* SubscribeNotificationsAnswer::setDRMP(){
	if(mDRMP == NULL)
	{
		mDRMP = new DRMP();
		mTagsPresent[SubscribeNotificationsAnswer_DRMP] = 1;
		return mDRMP;
	}
	return mDRMP;
}

void SubscribeNotificationsAnswer::resetDRMP(){
	mTagsPresent[SubscribeNotificationsAnswer_DRMP] = 0;
	if(mDRMP != NULL)
	{
		delete mDRMP; 
		mDRMP = NULL;
...
AuthSessionState* SubscribeNotificationsAnswer::setAuthSessionState(){
	mMandatoryAvpSetVal [SubscribeNotificationsAnswer_AUTHSESSIONSTATE] = 1;
	if(mAuthSessionState == NULL)
	{
		mAuthSessionState = new AuthSessionState();
		mTagsPresent[SubscribeNotificationsAnswer_AUTHSESSIONSTATE] = 1;
		return mAuthSessionState;
	}
	return mAuthSessionState;
}

void SubscribeNotificationsAnswer::resetAuthSessionState(){
	mTagsPresent[SubscribeNotificationsAnswer_AUTHSESSIONSTATE] = 0;
	if(mAuthSessionState != NULL)
	{
		delete mAuthSessionState; 
		mAuthSessionState = NULL;
...
Unsigned32* SubscribeNotificationsAnswer::setResultCode(){
	mMandatoryAvpSetVal [SubscribeNotificationsAnswer_RESULTCODE] = 1;
	if(mResultCode == NULL)
	{
		mResultCode = new Unsigned32();
		mTagsPresent[SubscribeNotificationsAnswer_RESULTCODE] = 1;
		return mResultCode;
	}
	return mResultCode;
}

void SubscribeNotificationsAnswer::resetResultCode(){
	mTagsPresent[SubscribeNotificationsAnswer_RESULTCODE] = 0;
	if(mResultCode != NULL)
	{
		delete mResultCode; 
		mResultCode = NULL;
...
OctetString* SubscribeNotificationsAnswer::setOriginHost(){
	mMandatoryAvpSetVal [SubscribeNotificationsAnswer_ORIGINHOST] = 1;
	if(mOriginHost == NULL)
	{
		mOriginHost = new OctetString();
		mTagsPresent[SubscribeNotificationsAnswer_ORIGINHOST] = 1;
		return mOriginHost;
	}
	return mOriginHost;
}

void SubscribeNotificationsAnswer::resetOriginHost(){
	mTagsPresent[SubscribeNotificationsAnswer_ORIGINHOST] = 0;
	if(mOriginHost != NULL)
	{
		delete mOriginHost; 
		mOriginHost = NULL;
...
OctetString* SubscribeNotificationsAnswer::setOriginRealm(){
	mMandatoryAvpSetVal [SubscribeNotificationsAnswer_ORIGINREALM] = 1;
	if(mOriginRealm == NULL)
	{
		mOriginRealm = new OctetString();
		mTagsPresent[SubscribeNotificationsAnswer_ORIGINREALM] = 1;
		return mOriginRealm;
	}
	return mOriginRealm;
}

void SubscribeNotificationsAnswer::resetOriginRealm(){
	mTagsPresent[SubscribeNotificationsAnswer_ORIGINREALM] = 0;
	if(mOriginRealm != NULL)
	{
		delete mOriginRealm; 
		mOriginRealm = NULL;
...
OctetString* SubscribeNotificationsAnswer::setWildcardedPublicIdentity(){
	if(mWildcardedPublicIdentity == NULL)
	{
		mWildcardedPublicIdentity = new OctetString();
		mTagsPresent[SubscribeNotificationsAnswer_WILDCARDEDPUBLICIDENTITY] = 1;
		return mWildcardedPublicIdentity;
	}
	return mWildcardedPublicIdentity;
}

void SubscribeNotificationsAnswer::resetWildcardedPublicIdentity(){
	mTagsPresent[SubscribeNotificationsAnswer_WILDCARDEDPUBLICIDENTITY] = 0;
	if(mWildcardedPublicIdentity != NULL)
	{
		delete mWildcardedPublicIdentity; 
		mWildcardedPublicIdentity = NULL;
...
OctetString* SubscribeNotificationsAnswer::setWildcardedIMPU(){
	if(mWildcardedIMPU == NULL)
	{
		mWildcardedIMPU = new OctetString();
		mTagsPresent[SubscribeNotificationsAnswer_WILDCARDEDIMPU] = 1;
		return mWildcardedIMPU;
	}
	return mWildcardedIMPU;
}

void SubscribeNotificationsAnswer::resetWildcardedIMPU(){
	mTagsPresent[SubscribeNotificationsAnswer_WILDCARDEDIMPU] = 0;
	if(mWildcardedIMPU != NULL)
	{
		delete mWildcardedIMPU; 
		mWildcardedIMPU = NULL;
...
OctetString* SubscribeNotificationsAnswer::setUserData(){
	mMandatoryAvpSetVal [SubscribeNotificationsAnswer_USERDATA] = 1;
	if(mUserData == NULL)
	{
		mUserData = new OctetString();
		mTagsPresent[SubscribeNotificationsAnswer_USERDATA] = 1;
		return mUserData;
	}
	return mUserData;
}

void SubscribeNotificationsAnswer::resetUserData(){
	mTagsPresent[SubscribeNotificationsAnswer_USERDATA] = 0;
	if(mUserData != NULL)
	{
		delete mUserData; 
		mUserData = NULL;
...
Time* SubscribeNotificationsAnswer::setExpiryTime(){
	if(mExpiryTime == NULL)
	{
		mExpiryTime = new Time();
		mTagsPresent[SubscribeNotificationsAnswer_EXPIRYTIME] = 1;
		return mExpiryTime;
	}
	return mExpiryTime;
}

void SubscribeNotificationsAnswer::resetExpiryTime(){
	mTagsPresent[SubscribeNotificationsAnswer_EXPIRYTIME] = 0;
	if(mExpiryTime != NULL)
	{
		delete mExpiryTime; 
		mExpiryTime = NULL;
...
OctetString* SubscribeNotificationsAnswer::getSessionId(){
	if(NULL == mSessionId) {
...
DRMP* SubscribeNotificationsAnswer::getDRMP(){
	if(NULL == mDRMP) {
...
SH::VendorSpecificApplicationId* SubscribeNotificationsAnswer::getVendorSpecificApplicationId()
{
	if(mVendorSpecificApplicationIdGrp == NULL)
	{
...
SH::VendorSpecificApplicationId* SubscribeNotificationsAnswer::setVendorSpecificApplicationId(){
	if(mVendorSpecificApplicationIdGrp == NULL)
		mVendorSpecificApplicationIdGrp = new VendorSpecificApplicationId();
	mTagsPresent[SubscribeNotificationsAnswer_VENDORSPECIFICAPPLICATIONID] = 1;
	mMandatoryAvpSetVal[SubscribeNotificationsAnswer_VENDORSPECIFICAPPLICATIONID] = 1;
	return mVendorSpecificApplicationIdGrp;
}

void SubscribeNotificationsAnswer::resetVendorSpecificApplicationId(){
	mTagsPresent[SubscribeNotificationsAnswer_VENDORSPECIFICAPPLICATIONID] = 0;
	if(mVendorSpecificApplicationIdGrp != NULL)
		delete mVendorSpecificApplicationIdGrp;
}

AuthSessionState* SubscribeNotificationsAnswer::getAuthSessionState(){
...
Unsigned32* SubscribeNotificationsAnswer::getResultCode(){
	if(NULL == mResultCode) {
...
ExperimentalResult* SubscribeNotificationsAnswer::getExperimentalResult()
{
	if(mExperimentalResultGrp == NULL)
	{
...
ExperimentalResult* SubscribeNotificationsAnswer::setExperimentalResult(){
	if(mExperimentalResultGrp == NULL)
		mExperimentalResultGrp = new ExperimentalResult();
	mTagsPresent[SubscribeNotificationsAnswer_EXPERIMENTALRESULT] = 1;
	mMandatoryAvpSetVal[SubscribeNotificationsAnswer_EXPERIMENTALRESULT] = 1;
	return mExperimentalResultGrp;
}

void SubscribeNotificationsAnswer::resetExperimentalResult(){
	mTagsPresent[SubscribeNotificationsAnswer_EXPERIMENTALRESULT] = 0;
	if(mExperimentalResultGrp != NULL)
		delete mExperimentalResultGrp;
}

OctetString* SubscribeNotificationsAnswer::getOriginHost(){
	if(NULL == mOriginHost) {
...
OctetString* SubscribeNotificationsAnswer::getOriginRealm(){
...
OctetString* SubscribeNotificationsAnswer::getWildcardedPublicIdentity(){
...
OctetString* SubscribeNotificationsAnswer::getWildcardedIMPU(){
...
list<SupportedFeatures*>* SubscribeNotificationsAnswer::getSupportedFeaturesGrpList()
{
	if(mSupportedFeaturesGrpList == NULL)
	{
	...
	for(auto itr : *mSupportedFeaturesGrpList)
	{
		...
		{
			mTagsPresent[SubscribeNotificationsAnswer_SUPPORTEDFEATURES] = 0;
			mSupportedFeaturesGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "SupportedFeatures is Null");
			throw lTssDiaMsgException;
		}
...
list<SupportedFeatures*>* SubscribeNotificationsAnswer::setSupportedFeaturesGrpList(){
	mTagsPresent[SubscribeNotificationsAnswer_SUPPORTEDFEATURES] = 1;
	if(mSupportedFeaturesGrpList == NULL)
...
void SubscribeNotificationsAnswer::resetSupportedFeaturesGrpList(){
	mTagsPresent[SubscribeNotificationsAnswer_SUPPORTEDFEATURES] = 0;
	if(mSupportedFeaturesGrpList != NULL)
		delete mSupportedFeaturesGrpList;
}

OctetString* SubscribeNotificationsAnswer::getUserData(){
	if(NULL == mUserData) {
...
Time* SubscribeNotificationsAnswer::getExpiryTime(){
	if(NULL == mExpiryTime) {
...
OCSupportedFeatures* SubscribeNotificationsAnswer::getOCSupportedFeatures()
{
	if(mOCSupportedFeaturesGrp == NULL)
	{
...
OCSupportedFeatures* SubscribeNotificationsAnswer::setOCSupportedFeatures(){
	if(mOCSupportedFeaturesGrp == NULL)
		mOCSupportedFeaturesGrp = new OCSupportedFeatures();
	mTagsPresent[SubscribeNotificationsAnswer_OCSUPPORTEDFEATURES] = 1;
	return mOCSupportedFeaturesGrp;
}

void SubscribeNotificationsAnswer::resetOCSupportedFeatures(){
	mTagsPresent[SubscribeNotificationsAnswer_OCSUPPORTEDFEATURES] = 0;
	if(mOCSupportedFeaturesGrp != NULL)
		delete mOCSupportedFeaturesGrp;
}

OCOLR* SubscribeNotificationsAnswer::getOCOLR()
{
	if(mOCOLRGrp == NULL)
	{
...
OCOLR* SubscribeNotificationsAnswer::setOCOLR(){
	if(mOCOLRGrp == NULL)
		mOCOLRGrp = new OCOLR();
	mTagsPresent[SubscribeNotificationsAnswer_OCOLR] = 1;
	return mOCOLRGrp;
}

void SubscribeNotificationsAnswer::resetOCOLR(){
	mTagsPresent[SubscribeNotificationsAnswer_OCOLR] = 0;
	if(mOCOLRGrp != NULL)
		delete mOCOLRGrp;
}

list<Load*>* SubscribeNotificationsAnswer::getLoadGrpList()
{
	if(mLoadGrpList == NULL)
	{
	...
	for(auto itr : *mLoadGrpList)
	{
		...
		{
			mTagsPresent[SubscribeNotificationsAnswer_LOAD] = 0;
			mLoadGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "Load is Null");
			throw lTssDiaMsgException;
		}
...
list<Load*>* SubscribeNotificationsAnswer::setLoadGrpList(){
	mTagsPresent[SubscribeNotificationsAnswer_LOAD] = 1;
	if(mLoadGrpList == NULL)
...
void SubscribeNotificationsAnswer::resetLoadGrpList(){
	mTagsPresent[SubscribeNotificationsAnswer_LOAD] = 0;
	if(mLoadGrpList != NULL)
		delete mLoadGrpList;
}

FailedAVP* SubscribeNotificationsAnswer::getFailedAVP()
{
	if(mFailedAVPGrp == NULL)
	{
...
FailedAVP* SubscribeNotificationsAnswer::setFailedAVP(){
	if(mFailedAVPGrp == NULL)
		mFailedAVPGrp = new FailedAVP();
	mTagsPresent[SubscribeNotificationsAnswer_FAILEDAVP] = 1;
	mMandatoryAvpSetVal[SubscribeNotificationsAnswer_FAILEDAVP] = 1;
	return mFailedAVPGrp;
}

void SubscribeNotificationsAnswer::resetFailedAVP(){
	mTagsPresent[SubscribeNotificationsAnswer_FAILEDAVP] = 0;
	if(mFailedAVPGrp != NULL)
		delete mFailedAVPGrp;
}

list<SH::ProxyInfo*>* SubscribeNotificationsAnswer::getProxyInfoGrpList()
{
	if(mProxyInfoGrpList == NULL)
	{
	...
	for(auto itr : *mProxyInfoGrpList)
	{
		...
		{
			mTagsPresent[SubscribeNotificationsAnswer_PROXYINFO] = 0;
			mProxyInfoGrpList = NULL;
			TssDiameterMsgException lTssDiaMsgException(DIAMETER_OBJ_NULL, "ProxyInfo is Null");
			throw lTssDiaMsgException;
		}
...
list<SH::ProxyInfo*>* SubscribeNotificationsAnswer::setProxyInfoGrpList(){
	mTagsPresent[SubscribeNotificationsAnswer_PROXYINFO] = 1;
	if(mProxyInfoGrpList == NULL)
		mProxyInfoGrpList = new list<SH::ProxyInfo*>;
	mMandatoryAvpSetVal[SubscribeNotificationsAnswer_PROXYINFO] = 1;
	mProxyInfoGrpList->clear();
	return mProxyInfoGrpList;
}

void SubscribeNotificationsAnswer::resetProxyInfoGrpList(){
	mTagsPresent[SubscribeNotificationsAnswer_PROXYINFO] = 0;
	if(mProxyInfoGrpList != NULL)
		delete mProxyInfoGrpList;
}

list<OctetString*>* SubscribeNotificationsAnswer::getRouteRecordList()
{
	if(mRouteRecordList == NULL)
	{
...
list<OctetString*>* SubscribeNotificationsAnswer::setRouteRecordList() {
	mTagsPresent[SubscribeNotificationsAnswer_ROUTERECORD] = 1;
	if(mRouteRecordList == NULL)
		mRouteRecordList = new list<OctetString*>;
	mMandatoryAvpSetVal [SubscribeNotificationsAnswer_ROUTERECORD] = 1;
	mRouteRecordList->clear();
	return mRouteRecordList;
}

void SubscribeNotificationsAnswer::resetRouteRecordList(){
	mTagsPresent[SubscribeNotificationsAnswer_ROUTERECORD] = 0;
	if(mRouteRecordList != NULL)
		delete mRouteRecordList;
}
...
int SubscribeNotificationsAnswer::Encode(byteArray *array)
{
	...
	for(unsigned int i = 0 ; i < mTagsPresent.size() ; ++i )
	{
		...
		switch(i)
		{
			case SubscribeNotificationsAnswer_SESSIONID:
			{
					array->size+=4;
				...
				break;
			case SubscribeNotificationsAnswer_DRMP:
			{
					array->size+=4;
				...
				break;
			case SubscribeNotificationsAnswer_VENDORSPECIFICAPPLICATIONID:
			{
				array->size+=4;
				...
				break;
			case SubscribeNotificationsAnswer_AUTHSESSIONSTATE:
			{
					array->size+=4;
				...
				break;
			case SubscribeNotificationsAnswer_RESULTCODE:
			{
					array->size+=4;
				...
				break;
			case SubscribeNotificationsAnswer_EXPERIMENTALRESULT:
			{
				array->size+=4;
				...
				break;
			case SubscribeNotificationsAnswer_ORIGINHOST:
			{
					array->size+=4;
				...
				break;
			case SubscribeNotificationsAnswer_ORIGINREALM:
			{
					array->size+=4;
				...
				break;
			case SubscribeNotificationsAnswer_WILDCARDEDPUBLICIDENTITY:
			{
					array->size+=4;
				...
				break;
			case SubscribeNotificationsAnswer_WILDCARDEDIMPU:
			{
					array->size+=4;
				...
				break;
			case SubscribeNotificationsAnswer_SUPPORTEDFEATURES:
			{
				if( mSupportedFeaturesGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case SubscribeNotificationsAnswer_USERDATA:
			{
					array->size+=4;
				...
				break;
			case SubscribeNotificationsAnswer_EXPIRYTIME:
			{
					array->size+=4;
				...
				break;
			case SubscribeNotificationsAnswer_OCSUPPORTEDFEATURES:
			{
				array->size+=4;
				...
				break;
			case SubscribeNotificationsAnswer_OCOLR:
			{
				array->size+=4;
				...
				break;
			case SubscribeNotificationsAnswer_LOAD:
			{
				if( mLoadGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case SubscribeNotificationsAnswer_FAILEDAVP:
			{
				array->size+=4;
				...
				break;
			case SubscribeNotificationsAnswer_PROXYINFO:
			{
				if( mProxyInfoGrpList->size() <= 0) {
					break;
				}
				...
				break;
			case SubscribeNotificationsAnswer_ROUTERECORD:
			{
...
int SubscribeNotificationsAnswer::Decode(byteArray *array, INT16 lMLen, UINT16 *parsedBytes)
{
...
DiameterBaseInterface* SubscribeNotificationsAnswer::Find(byteArray *array, UINT32 avpCode)
{
...
BOOLEAN SubscribeNotificationsAnswer::FindAll(byteArray *array, UINT32 avpCode, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
std::shared_ptr<byteArray> SubscribeNotificationsAnswer::GetByteArray()
{
	return mspByteArray;
}


BOOLEAN SubscribeNotificationsAnswer::FindAll(byteArray *array, std::map<int,UINT32> &avpCodeMap, int &size, int key, list<DiameterBaseInterface*>& pBaseInterface,BOOLEAN deepInspect)
{
		if(!mDecodeFlag && array != NULL)
			this->Decode(array);
...
void SubscribeNotificationsAnswer::Display(UINT32 tab)
{
...
BOOLEAN SubscribeNotificationsAnswer::GetMissingAvpInfo(TEXT *lMissingAvpInfo)
{
