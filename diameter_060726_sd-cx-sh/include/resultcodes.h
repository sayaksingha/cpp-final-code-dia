// @(#) $Id: resultcodes.h,v 1.1.4.1.2.1 2018/02/21 23:00:45 anandhv Exp $
//---------------------------------------------------------------
// NAME : resultcodes.h
//
// COPYRIGHT
...
#define   AAA_ERROR_USER_UNKNOWN 5001

/* 	This error code is used to put in Experimental-Result AVP by S6 Appl & not be used in ResultCode.
   	This result code shall be sent by the HSS to indicate that the user 
		identified by the IMSI is unknown */

#define   AAA_ERROR_ROAMING_NOT_ALLOWED	5004

/* 	This error code is used to put in Experimental-Result AVP by S6 Appl & not be used in ResultCode.
 	 	This result code shall be sent by the HSS to indicate that the subscriber is not 
   	allowed to roam within the MME or SGSN area. */
