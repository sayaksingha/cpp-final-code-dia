// @(#) $Id: aaa_parser_defs.h,v 1.1.4.1.2.1 2018/02/21 23:00:44 anandhv Exp $
//---------------------------------------------------------------
// NAME : aaa_parser_defs.h
//
// COPYRIGHT
...
AAA_PARSER_SINGLETON_DECLARE(ACE_Singleton, AAAMemoryManager, ACE_Recursive_Thread_Mutex);
