static const char *id = " @(#) $Id: diameter_cc_server_fsm.cc,v 1.1.2.1.2.1 2024/05/15 13:03:29 mram Exp $";
//----------------------------------------------------------------------
// NAME
// diameter_cc_server_fsm.cc
//
// COPYRIGHT
...
class DiameterCCServerAction : public AAA_Action<DiameterCCServerStateMachine>
{
...
class DiameterCCServerStateTable_S : public AAA_StateTable<DiameterCCServerStateMachine>
{
	friend class ACE_Singleton<DiameterCCServerStateTable_S, ACE_Recursive_Thread_Mutex>;
	...
	class AcSuccessfulInitialAnswer : public DiameterCCServerAction 
	{
		void operator()(DiameterCCServerStateMachine& sm)
		{
			AAA_LOG((LM_DEBUG, "(%P|%t) Sending Successful Initial Answer.\n"));
