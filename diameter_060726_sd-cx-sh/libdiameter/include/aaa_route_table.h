// @(#) $Id: aaa_route_table.h,v 1.1.4.1.2.1.2.1 2018/09/20 02:53:53 anandhv Exp $
//---------------------------------------------------------------
// NAME : aaa_route_table.h
//
// COPYRIGHT
...
class DiameterRouteEntry : public OD_Utl_RbTreeData
{
   public:
      ...
      virtual void DumpIntoFile(void *userData);

   protected:
      std::string m_Realm;
      DIAMETER_ROUTE_ACTION m_Action;
		bool m_AdveriseRoute;
